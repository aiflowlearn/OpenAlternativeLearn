...
| [Agno](https://open.aiflowlearn.net/agno) - Open-source platform that enables developers to create, deploy and monitor AI agents with built-in memory,... | license: Apache-2.0<br>⭐ Star: 41K | Kiro, LangChain, Humanloop | [Codex](https://www.aiflowlearn.net/codex/agno-agi-agno) | Coming soon |
...
| [Bifrost](https://open.aiflowlearn.net/bifrost) - Open-source AI gateway delivering 50x faster performance than alternatives. | license: Apache-2.0<br>⭐ Star: 5.7K | Eden AI, OpenRouter, Vercel AI Gateway | [Codex](https://www.aiflowlearn.net/codex/bifrost) | Coming soon |
...
| [CopilotKit](https://open.aiflowlearn.net/copilotkit) - Integrate production-ready AI copilots into any product quickly and easily with CopilotKit's open-source... | license: MIT<br>⭐ Star: 35K | - | [Codex](https://www.aiflowlearn.net/codex/copilotkit-copilotkit) | Coming soon |
| [Daytona](https://open.aiflowlearn.net/daytona) - Elastic sandbox infrastructure for running AI-generated code with sub-90ms environment creation, stateful... | license: AGPL-3.0<br>⭐ Star: 72K | Together Sandbox, Modal, Sprites | [Codex](https://www.aiflowlearn.net/codex/daytonaio-daytona) | Coming soon |
| [Dify](https://open.aiflowlearn.net/dify) - Visual platform for building agentic workflows, RAG pipelines, and LLM-powered apps. | license: Unknown<br>⭐ Star: 145K | Glide, Retool, Humanloop | [Codex](https://www.aiflowlearn.net/codex/dify-llm-workflow-platform) | [Classroom](https://open.aiflowlearn.net/classroom/dify) |
...
| [Flowise AI](https://open.aiflowlearn.net/flowise-ai) - Open source platform for building AI agents, chatbots, and multi-agent systems using a drag-and-drop... | license: Apache-2.0<br>⭐ Star: 54K | n8n, Make, Power Apps | [Codex](https://www.aiflowlearn.net/codex/flowiseai-flowise) | [Classroom](https://open.aiflowlearn.net/classroom/flowise-ai) |
...
| [LiteLLM](https://open.aiflowlearn.net/litellm) - Acts as a unified proxy across 100+ LLMs, normalizing them to the OpenAI format while handling virtual... | license: Unknown<br>⭐ Star: 50K | LangChain, Eden AI, OpenRouter | [Codex](https://www.aiflowlearn.net/codex/berriai-litellm) | Coming soon |
| [LLM Gateway](https://open.aiflowlearn.net/llm-gateway) - Route, manage, and analyze LLM requests across multiple providers with one API. | license: MIT<br>⭐ Star: 1.3K | Eden AI, Vercel AI Gateway, Cloudflare AI Gateway | [Codex](https://www.aiflowlearn.net/codex/llm-gateway) | Coming soon |
| [LobeChat](https://open.aiflowlearn.net/lobechat) - A collaborative platform to create, schedule, and operate AI agents that handle long-running tasks, team... | license: Unknown<br>⭐ Star: 79K | Claude, Grok, ChatGPT | [Codex](https://www.aiflowlearn.net/codex/lobe-chat-multi-agent) | Coming soon |
...
| [Milvus](https://open.aiflowlearn.net/milvus) - Open-source vector database optimized for similarity search, scaling to billions of vectors with minimal... | license: Apache-2.0<br>⭐ Star: 45K | Supabase, Pinecone, ElasticSearch | [Codex](https://www.aiflowlearn.net/codex/milvus-io-milvus) | Coming soon |
...
| [Portkey AI Gateway](https://open.aiflowlearn.net/portkey-ai-gateway) - Comprehensive AI platform with gateway, observability, guardrails, and prompt management. | license: MIT<br>⭐ Star: 12K | Eden AI, Vercel AI Gateway, Cloudflare AI Gateway | [Codex](https://www.aiflowlearn.net/codex/portkey-ai-gateway) | Coming soon |
...
| [Helicone](https://open.aiflowlearn.net/helicone) - Open-source platform for logging, monitoring, and debugging LLM applications. | license: Apache-2.0<br>⭐ Star: 5.8K | DataDog, LangSmith, LangChain | [Codex](https://www.aiflowlearn.net/codex/helicone) | Coming soon |
...
| [Browser Use](https://open.aiflowlearn.net/browser-use) - Python library that lets AI agents browse the web by giving them real browser control, DOM access, and the... | license: MIT<br>⭐ Star: 99K | Browserbase, Anchor Browser | [Codex](https://www.aiflowlearn.net/codex/browser-use-source-walkthrough) | Coming soon |
...
| [Jan](https://open.aiflowlearn.net/jan) - Jan runs open-source AI models on your own hardware or connects to cloud providers like OpenAI, Anthropic,... | license: Apache-2.0<br>⭐ Star: 43K | Claude, Grok, ChatGPT | [Codex](https://www.aiflowlearn.net/codex/janhq-jan) | Coming soon |
...
| [Open WebUI](https://open.aiflowlearn.net/open-webui) - Self-hosted AI platform that connects local and cloud models, extends with Python, and keeps your data... | license: BSD-3-Clause<br>⭐ Star: 141K | Claude, Grok, ChatGPT | [Codex](https://www.aiflowlearn.net/codex/open-webui-open-webui) | Coming soon |
| [OpenClaw](https://open.aiflowlearn.net/openclaw) - A personal AI assistant that connects to your existing chat apps and handles real tasks like email,... | license: MIT<br>⭐ Star: 379K | Zo Computer, Personal Computer | [Codex](https://www.aiflowlearn.net/codex/openclaw-personal-ai-platform) | Coming soon |
...
| [Docuseal](https://open.aiflowlearn.net/docuseal) - DocuSeal is an open source e-signature platform that provides fast, easy document signing with... | license: AGPL-3.0<br>⭐ Star: 17K | DocuSign, PandaDoc | [Codex](https://www.aiflowlearn.net/codex/docusealco-docuseal) | Coming soon |
...
| [Deepnote](https://open.aiflowlearn.net/deepnote) - Deepnote is an open-source collaborative notebook for data analysts and scientists, combining Python, SQL,... | license: Apache-2.0<br>⭐ Star: 2.9K | Snowflake, Tableau, Hex | Coming soon | Coming soon |
| [OpenBB](https://open.aiflowlearn.net/openbb) - Connects proprietary, licensed, and public financial data with AI agents in a self-hostable workspace for... | license: Unknown<br>⭐ Star: 69K | Power BI, Bloomberg Terminal, Tableau | Coming soon | Coming soon |
| [Apache Superset](https://open.aiflowlearn.net/apache-superset) - Connect any SQL database, build charts with drag-and-drop or raw SQL, and publish interactive dashboards... | license: Apache-2.0<br>⭐ Star: 73K | Power BI, Splunk, Tableau | [Codex](https://www.aiflowlearn.net/codex/superset-sh-superset) | Coming soon |
...
| [CocoIndex](https://open.aiflowlearn.net/cocoindex) - Open-source ETL framework built in Rust for AI workloads. | license: Apache-2.0<br>⭐ Star: 10K | Pipedream, Amazon API Gateway, Segment | [Codex](https://www.aiflowlearn.net/codex/cocoindex-io-cocoindex) | Coming soon |
...
| [n8n](https://open.aiflowlearn.net/n8n) - Build automated workflows connecting 500+ apps, write custom code, and deploy AI agents with full... | license: Unknown<br>⭐ Star: 192K | Make, Zapier, IFTTT | [Codex](https://www.aiflowlearn.net/codex/n8n-io-n8n) | Coming soon |
...
| [Warp](https://open.aiflowlearn.net/warp) - Terminal built for running AI coding agents like Claude Code, Codex, and Gemini CLI, with shared context,... | license: AGPL-3.0<br>⭐ Star: 62K | - | [Codex](https://www.aiflowlearn.net/codex/warp-agentic-terminal) | Coming soon |
...
| [Fincept Terminal](https://open.aiflowlearn.net/fincept-terminal) - Comprehensive financial data platform offering economic insights, market analysis, and portfolio... | license: Unknown<br>⭐ Star: 27K | - | [Codex](https://www.aiflowlearn.net/codex/fincept-corporation-finceptterminal) | Coming soon |
