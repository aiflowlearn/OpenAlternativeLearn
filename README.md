...
## Additional Open-Source Projects with Codex Courses

These projects already have Codex architecture courses and are listed in the same directory-table format as the main OpenAlternativeLearn catalog.
...
| [CopilotKit](https://open.aiflowlearn.net/copilotkit) - CopilotKit: Frontend infrastructure for in-app AI copilots | license: MIT<br>⭐ Star: 35K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/copilotkit-copilotkit) | Coming soon |
...
| [Rivet](https://open.aiflowlearn.net/rivet) - Rivet: How Stateful Actors Give AI Agents Memory | license: Apache-2.0<br>⭐ Star: 5.6K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/rivet) | Coming soon |
...
| Langchain Ai Deepagents - Deep Agents Interactive Course | license: MIT<br>⭐ Star: 24.5K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/langchain-ai-deepagents) | Coming soon |
| [agency agents](https://github.com/msitarzewski/agency-agents) - Agency Agents · Multi-Agent Organizational Framework | license: MIT<br>⭐ Star: 114K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/msitarzewski-agency-agents) | Coming soon |
| [agent governance toolkit](https://github.com/microsoft/agent-governance-toolkit) - Agent Governance Toolkit: AI agent governance framework | license: MIT<br>⭐ Star: 4.4K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/microsoft-agent-governance-toolkit) | Coming soon |
| [agentsview](https://github.com/kenn-io/agentsview) - Architecture walkthrough for an AI agent or application framework: agentsview. | license: MIT<br>⭐ Star: 2.8K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/kenn-io-agentsview) | Coming soon |
| [ai agents for beginners](https://github.com/microsoft/ai-agents-for-beginners) - AI Agents for Beginners: Microsoft's official beginner path for agent systems | license: MIT<br>⭐ Star: 67.4K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/microsoft-ai-agents-for-beginners) | Coming soon |
| [ai engineering hub](https://github.com/patchy631/ai-engineering-hub) - AI Engineering Hub: practical LLM, RAG, and agent engineering tutorials | license: MIT<br>⭐ Star: 35.8K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/patchy631-ai-engineering-hub) | Coming soon |
| [ai hedge fund](https://github.com/virattt/ai-hedge-fund) - Architecture walkthrough for an AI agent or application framework: ai hedge fund. | license: MIT<br>⭐ Star: 60.2K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/ai-hedge-fund-autonomous) | Coming soon |
| [anthropic cookbook](https://github.com/anthropics/anthropic-cookbook) - Anthropic Cookbook Anatomy Course: From Augmented LLM to Complete Agentic Architecture | license: MIT<br>⭐ Star: 45.6K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/anthropic-cookbook) | Coming soon |
| [archon](https://github.com/coleam00/archon) - Archon Interactive Course | license: MIT<br>⭐ Star: 22.4K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/coleam00-archon) | Coming soon |
| [astrid](https://github.com/unicity-astrid/astrid) - Astrid · AI Agent Operating System | license: Apache-2.0<br>⭐ Star: 9.2K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/astrid) | Coming soon |
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) - AutoGPT: Autonomous AI Agent Platform for Everyone | license: NOASSERTION<br>⭐ Star: 185K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/significant-gravitas-autogpt) | Coming soon |
| [awesome llm apps](https://github.com/Shubhamsaboo/awesome-llm-apps) - awesome-llm-apps: Runnable Agent and RAG App Examples Repository | license: Apache-2.0<br>⭐ Star: 114.8K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/shubhamsaboo-awesome-llm-apps) | Coming soon |
| [craft agents oss](https://github.com/lukilabs/craft-agents-oss) - Craft Agents: TypeScript Agent Framework in Practice | license: Apache-2.0<br>⭐ Star: 6.3K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/craft-agents-typescript) | Coming soon |
| [crewAI](https://github.com/crewAIInc/crewAI) - crewAI: Multi-role AI Agent collaboration orchestration framework | license: MIT<br>⭐ Star: 53.8K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/crewaiinc-crewai) | Coming soon |
| [deer flow](https://github.com/bytedance/deer-flow) - Architecture walkthrough for an AI agent or application framework: deer flow. | license: MIT<br>⭐ Star: 71.4K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/bytedance-deer-flow) | Coming soon |
| [dexter](https://github.com/virattt/dexter) - Dexter · Autonomous Data Analysis Agent | license: Unknown<br>⭐ Star: 27.1K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/virattt-dexter) | Coming soon |
| [firecrawl](https://github.com/firecrawl/firecrawl) - Firecrawl: Web Scraping and Search APIs for AI Agents | license: AGPL-3.0<br>⭐ Star: 133.8K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/firecrawl-firecrawl) | Coming soon |
| [GenericAgent](https://github.com/lsdefine/GenericAgent) - Self-Evolving Agent: Skill Tree Growing from a 3300-Line Seed | license: MIT<br>⭐ Star: 12.9K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/generic-agent-skill-tree) | Coming soon |
| [goose](https://github.com/aaif-goose/goose) - Architecture walkthrough for an AI agent or application framework: goose. | license: Apache-2.0<br>⭐ Star: 49.6K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/aaif-goose-goose) | Coming soon |
| [gpt researcher](https://github.com/assafelovic/gpt-researcher) - GPT Researcher: Autonomous Research Agent Source Code Analysis | license: Apache-2.0<br>⭐ Star: 27.8K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/assafelovic-gpt-researcher) | Coming soon |
| [hello agents](https://github.com/datawhalechina/hello-agents) - Hello Agents · Agent Beginner's Map | license: NOASSERTION<br>⭐ Star: 59.9K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/datawhalechina-hello-agents) | Coming soon |
| [hermes agent](https://github.com/NousResearch/hermes-agent) - Hermes Agent: A Complete Guide to Self-Growing AI Agent Architecture | license: MIT<br>⭐ Star: 195.7K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/hermes-agent-growing) | Coming soon |
| [hyperframes](https://github.com/heygen-com/hyperframes) - Hyperframes: agentic HTML-to-video generation workflow | license: Apache-2.0<br>⭐ Star: 28.2K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/heygen-com-hyperframes) | Coming soon |
| [langgraph](https://github.com/langchain-ai/langgraph) - LangGraph · Controllable Agent State Machine | license: MIT<br>⭐ Star: 35K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/langchain-ai-langgraph) | Coming soon |
| [llama index](https://github.com/run-llama/llama_index) - LlamaIndex: A Document Agent Framework Connecting Private Data with LLMs | license: MIT<br>⭐ Star: 50.2K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/run-llama-llama-index) | Coming soon |
| [memvid](https://github.com/memvid/memvid) - Architecture walkthrough for an AI agent or application framework: memvid. | license: Apache-2.0<br>⭐ Star: 15.7K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/memvid-memvid) | Coming soon |
| [nanobot](https://github.com/HKUDS/nanobot) - Architecture walkthrough for an AI agent or application framework: nanobot. | license: MIT<br>⭐ Star: 44.4K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/hkuds-nanobot) | Coming soon |
| [oh my openagent](https://github.com/code-yeongyu/oh-my-openagent) - Oh My OpenAgent: coding-agent harness and workflow patterns | license: NOASSERTION<br>⭐ Star: 62.5K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/code-yeongyu-oh-my-openagent) | Coming soon |
| [open deep research](https://github.com/langchain-ai/open-deep-research) - Open Deep Research · Open Source Deep Research Agent | license: Unknown<br>⭐ Star: Unknown | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/langchain-ai-open-deep-research) | Coming soon |
| [OpenMAIC](https://github.com/THU-MAIC/OpenMAIC) - OpenMAIC: AI Multi-Agent Interactive Classroom | license: AGPL-3.0<br>⭐ Star: 18.6K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/openmaic) | Coming soon |
| Pi Mono By Badlogic - Pi Mono Anatomy Lesson: How 5 Packages Make One AI Programming Agent | license: Unknown<br>⭐ Star: Unknown | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/pi-mono-by-badlogic) | Coming soon |
| [pydantic ai](https://github.com/pydantic/pydantic-ai) - Pydantic AI · Type-Safe Agent Framework | license: MIT<br>⭐ Star: 17.8K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/pydantic-pydantic-ai) | Coming soon |
| [Qwen Agent](https://github.com/QwenLM/Qwen-Agent) - Qwen-Agent · Tongyi Qwen Agent Framework | license: Apache-2.0<br>⭐ Star: 16.6K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/qwenlm-qwen-agent) | Coming soon |
| [serenity skill](https://github.com/muxuuu/serenity-skill) - Architecture walkthrough for an AI agent or application framework: serenity skill. | license: MIT<br>⭐ Star: 2.4K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/muxuuu-serenity-skill) | Coming soon |
| [smolagents](https://github.com/huggingface/smolagents) - smolagents · Minimalist Agent Framework | license: Apache-2.0<br>⭐ Star: 27.9K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/huggingface-smolagents) | Coming soon |
| [superpowers](https://github.com/obra/superpowers) - Superpowers: A Complete Guide to AI Agent Skill Systems | license: MIT<br>⭐ Star: 230.3K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/superpowers-agent-framework) | Coming soon |
| [TradingAgents](https://github.com/TauricResearch/TradingAgents) - TradingAgents Multi-Agent Trading Framework — Interactive Course | license: Apache-2.0<br>⭐ Star: 86.8K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/tauricresearch-tradingagents) | Coming soon |
| [TradingAgents](https://github.com/TauricResearch/TradingAgents) - TradingAgents: How 5 AI Analysts Collaborate on Trading Decisions | license: Apache-2.0<br>⭐ Star: 86.8K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/trading-agents-multi-llm) | Coming soon |
| [UI TARS desktop](https://github.com/bytedance/UI-TARS-desktop) - Architecture walkthrough for an AI agent or application framework: UI TARS desktop. | license: Apache-2.0<br>⭐ Star: 36.6K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/bytedance-ui-tars-desktop) | Coming soon |
...
| [Warp](https://open.aiflowlearn.net/warp) - Warp: An In-Depth Look at the Next-Gen Agentic Development Terminal | license: AGPL-3.0<br>⭐ Star: 62K | OpenAI Assistants API, Relevance AI, Dust | [Codex](https://www.aiflowlearn.net/en/codex/warp-agentic-terminal) | Coming soon |
...
| Siddharthvaddem Openscreen - Architecture walkthrough for an AI coding or developer-tool project: Siddharthvaddem Openscreen. | license: MIT<br>⭐ Star: 38.5K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/siddharthvaddem-openscreen) | Coming soon |
| [openclacky](https://github.com/clacky-ai/openclacky) - OpenClacky Source Code Analysis: Building a Multi-Channel AI Agent with Ruby | license: MIT<br>⭐ Star: 943 | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/openclacky-source-walkthrough) | Coming soon |
| [agentmemory](https://github.com/rohitg00/agentmemory) - agentmemory Interactive Course — Give AI Coding Assistants Memory | license: Apache-2.0<br>⭐ Star: 23.2K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/rohitg00-agentmemory) | Coming soon |
| [andrej karpathy skills](https://github.com/forrestchang/andrej-karpathy-skills) - Karpathy's AI Coding Wisdom: How Top Engineers Harness LLMs | license: Unknown<br>⭐ Star: 177.2K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/karpathy-ai-coding-wisdom) | Coming soon |
| [Archon](https://github.com/coleam00/Archon) - Architecture walkthrough for an AI coding or developer-tool project: Archon. | license: MIT<br>⭐ Star: 22.4K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/archon-ai-coding-harness) | Coming soon |
| [awesome claude design course](https://github.com/danielli0522/awesome-claude-design-course) - Architecture walkthrough for an AI coding or developer-tool project: awesome claude design course. | license: Unknown<br>⭐ Star: 1 | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/awesome-claude-design) | Coming soon |
| [awesome mcp servers](https://github.com/punkpeye/awesome-mcp-servers) - awesome-mcp-servers: MCP Server Ecosystem Navigation List | license: MIT<br>⭐ Star: 89.3K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/punkpeye-awesome-mcp-servers) | Coming soon |
| [awesome vibe coding](https://github.com/filipecalegario/awesome-vibe-coding) - Vibe Coding Series 3 (Tools) · Tool Map | license: CC0-1.0<br>⭐ Star: 4.8K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/awesome-vibe-coding) | Coming soon |
| [BettaFish](https://github.com/666ghj/BettaFish) - Architecture walkthrough for an AI coding or developer-tool project: BettaFish. | license: GPL-2.0<br>⭐ Star: 41.4K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/666ghj-bettafish) | Coming soon |
| [cc switch](https://github.com/farion1231/cc-switch) - cc-switch: Desktop Switcher for Multiple AI Coding Assistants | license: MIT<br>⭐ Star: 103K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/farion1231-cc-switch) | Coming soon |
| [chrome devtools mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) - Chrome DevTools MCP: Let AI Coding Assistants Control Browser Debugging | license: Apache-2.0<br>⭐ Star: 43.8K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/chromedevtools-chrome-devtools-mcp) | Coming soon |
| [claude context](https://github.com/zilliztech/claude-context) - Architecture walkthrough for an AI coding or developer-tool project: claude context. | license: MIT<br>⭐ Star: 11.9K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/zilliztech-claude-context) | Coming soon |
| [claude howto](https://github.com/luongnv89/claude-howto) - Claude Code Practical Guide: From Beginner to Mastery | license: MIT<br>⭐ Star: 37.4K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/luongnv89-claude-howto) | Coming soon |
| [claude mem](https://github.com/thedotmack/claude-mem) - Architecture walkthrough for an AI coding or developer-tool project: claude mem. | license: Apache-2.0<br>⭐ Star: 82.9K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/claude-mem-persistent-memory) | Coming soon |
| [claude subconscious](https://github.com/letta-ai/claude-subconscious) - Architecture walkthrough for an AI coding or developer-tool project: claude subconscious. | license: MIT<br>⭐ Star: 2.8K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/letta-ai-claude-subconscious) | Coming soon |
| [claw code](https://github.com/ultraworkers/claw-code) - claw-code: High-Performance Rust Coding Agent Architecture | license: MIT<br>⭐ Star: 193.9K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/ultraworkers-claw-code) | Coming soon |
| [claw0](https://github.com/shareAI-lab/claw0) - Claw0: Lightweight AI Agent Gateway Source Code Analysis | license: Unknown<br>⭐ Star: 2.9K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/shareai-lab-claw0) | Coming soon |
| [codebuff](https://github.com/CodebuffAI/codebuff) - Architecture walkthrough for an AI coding or developer-tool project: codebuff. | license: Apache-2.0<br>⭐ Star: 6.5K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/codebuffai-codebuff) | Coming soon |
| [CodeGraph](https://github.com/colbymchenry/CodeGraph) - CodeGraph — Equipping AI Coding Agents with a Code Map | license: MIT<br>⭐ Star: 50.7K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/colbymchenry-codegraph) | Coming soon |
| [CodeWhale](https://github.com/Hmbown/CodeWhale) - Architecture walkthrough for an AI coding or developer-tool project: CodeWhale. | license: MIT<br>⭐ Star: 38.5K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/hmbown-codewhale) | Coming soon |
| [codex](https://github.com/openai/codex) - OpenAI Codex · Command-Line AI Coding Agent | license: Apache-2.0<br>⭐ Star: 91.6K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/openai-codex) | Coming soon |
| [Deep Live Cam](https://github.com/hacksider/Deep-Live-Cam) - Deep-Live-Cam: Real-time Face Swapping with a Single Photo | license: AGPL-3.0<br>⭐ Star: 93.9K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/hacksider-deep-live-cam) | Coming soon |
| [easy vibe](https://github.com/datawhalechina/easy-vibe) - Vibe Coding Series 1 (Beginner) · Easy-Vibe Introductory Journey | license: Unknown<br>⭐ Star: 17K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/easy-vibe) | Coming soon |
| [ECC](https://github.com/affaan-m/ECC) - Everything Claude Code · AI Programming Workbench | license: MIT<br>⭐ Star: 216.9K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/ecc-everything-claude-code) | Coming soon |
| [everything claude code](https://github.com/affaan-m/everything-claude-code) - Architecture walkthrough for an AI coding or developer-tool project: everything claude code. | license: MIT<br>⭐ Star: 216.9K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/affaan-everything-claude-code) | Coming soon |
| [evolver](https://github.com/EvoMap/evolver) - Architecture walkthrough for an AI coding or developer-tool project: evolver. | license: GPL-3.0<br>⭐ Star: 8.8K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/evomap-evolver) | Coming soon |
| [floci](https://github.com/floci-io/floci) - Architecture walkthrough for an AI coding or developer-tool project: floci. | license: MIT<br>⭐ Star: 14.2K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/floci-io-floci) | Coming soon |
| [free claude code](https://github.com/Alishahryar1/free-claude-code) - Free Claude Code: running Claude Code with a zero-cost terminal workflow | license: MIT<br>⭐ Star: 35K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/free-claude-code-terminal) | Coming soon |
| [gallery](https://github.com/google-ai-edge/gallery) - Overview of On-Device ML/GenAI Deployment Cases | license: Apache-2.0<br>⭐ Star: 23.8K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/google-ai-edge-gallery) | Coming soon |
| [gemini cli](https://github.com/google-gemini/gemini-cli) - Gemini CLI: Google's AI Coding Assistant Explained | license: Apache-2.0<br>⭐ Star: 105.4K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/gemini-cli-coding-agent) | Coming soon |
| [generative ai](https://github.com/GoogleCloudPlatform/generative-ai) - Architecture walkthrough for an AI coding or developer-tool project: generative ai. | license: Apache-2.0<br>⭐ Star: 17K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/googlecloudplatform-generative-ai) | Coming soon |
| [GitNexus](https://github.com/abhigyanpatwari/GitNexus) - Architecture walkthrough for an AI coding or developer-tool project: GitNexus. | license: NOASSERTION<br>⭐ Star: 42.3K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/abhigyanpatwari-gitnexus) | Coming soon |
| [GitNexus](https://github.com/abhigyanpatwari/GitNexus) - Architecture walkthrough for an AI coding or developer-tool project: GitNexus. | license: NOASSERTION<br>⭐ Star: 42.3K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/gitnexus-ai-git-workflow) | Coming soon |
| [gstack](https://github.com/garrytan/gstack) - gstack: The Ultimate Tool Configuration System for Top Managers | license: MIT<br>⭐ Star: 110.8K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/garrytan-gstack-dev-ops) | Coming soon |
| [headroom](https://github.com/chopratejas/headroom) - Architecture walkthrough for an AI coding or developer-tool project: headroom. | license: Apache-2.0<br>⭐ Star: 30.4K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/chopratejas-headroom) | Coming soon |
| [honker](https://github.com/russellromney/honker) - Honker: open-source threat intelligence search platform | license: NOASSERTION<br>⭐ Star: 2.9K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/russellromney-honker) | Coming soon |
| [last30days skill](https://github.com/mvanhorn/last30days-skill) - Last30Days Skill：Using Claude Code to Track Hot Topics | license: MIT<br>⭐ Star: 43.7K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/mvanhorn-last30days-skill) | Coming soon |
| [learn claude code](https://github.com/shareAI-lab/learn-claude-code) - Architecture walkthrough for an AI coding or developer-tool project: learn claude code. | license: MIT<br>⭐ Star: 67.1K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/shareai-lab-learn-claude-code) | Coming soon |
| [maigret](https://github.com/soxoj/maigret) - Maigret Source Code Analysis: From Username to Digital Portrait | license: MIT<br>⭐ Star: 33.2K | Snyk, Semgrep, Browserbase | [Codex](https://www.aiflowlearn.net/en/codex/soxoj-maigret) | Coming soon |
| [mcp server](https://github.com/figma/mcp-server) - Architecture walkthrough for an AI coding or developer-tool project: mcp server. | license: Unknown<br>⭐ Star: Unknown | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/figma-mcp-server-guide) | Coming soon |
| [MiroFish](https://github.com/666ghj/MiroFish) - MiroFish: Predicting Everything with Swarm Intelligence | license: AGPL-3.0<br>⭐ Star: 66.7K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/666ghj-mirofish) | Coming soon |
| [odysseus](https://github.com/pewdiepie-archdaemon/odysseus) - Odysseus · Self-Hosted AI Workspace | license: AGPL-3.0<br>⭐ Star: 72.6K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/odysseus) | Coming soon |
| [openclacky](https://github.com/clacky-ai/openclacky) - Architecture walkthrough for an AI coding or developer-tool project: openclacky. | license: MIT<br>⭐ Star: 1K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/clacky-ai-openclacky) | Coming soon |
| Opencode Ai Opencode - OpenCode Source Code Walkthrough — An AI Programming Assistant in Your Terminal | license: Unknown<br>⭐ Star: Unknown | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/opencode-ai-opencode) | Coming soon |
| [OpenHands](https://github.com/All-Hands-AI/OpenHands) - OpenHands: Open Source AI Coding Agent Platform Architecture | license: NOASSERTION<br>⭐ Star: 77.5K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/openhands-coding-agent) | Coming soon |
| [openhuman](https://github.com/tinyHumansAI/openhuman) - OpenHuman: How Your AI Assistant Works | license: GPL-3.0<br>⭐ Star: 32.5K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/tinyhumansai-openhuman) | Coming soon |
| [paperclip](https://github.com/paperclipai/paperclip) - Paperclip: Automated Operations Architecture for a Zero-Human Company | license: MIT<br>⭐ Star: 70.7K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/paperclipai-zero-human-org) | Coming soon |
| [pinia](https://github.com/vuejs/pinia) - Architecture walkthrough for an AI coding or developer-tool project: pinia. | license: MIT<br>⭐ Star: 14.6K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/pinia-pinia) | Coming soon |
| [project nomad](https://github.com/Crosstalk-Solutions/project-nomad) - Architecture walkthrough for an AI coding or developer-tool project: project nomad. | license: Apache-2.0<br>⭐ Star: 31K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/crosstalk-solutions-project-nomad) | Coming soon |
| [rtk](https://github.com/rtk-ai/rtk) - RTK: Principles and Implementation of 60-90% Token Compression Proxy | license: Apache-2.0<br>⭐ Star: 63.1K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/rtk-llm-token-compression) | Coming soon |
| [ruflo](https://github.com/ruvnet/ruflo) - Ruflo Interactive Course — Multi-Agent AI Orchestration Engine | license: MIT<br>⭐ Star: 59.9K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/ruvnet-ruflo) | Coming soon |
| [shadPS4](https://github.com/shadps4-emu/shadPS4) - Architecture walkthrough for an AI coding or developer-tool project: shadPS4. | license: GPL-2.0<br>⭐ Star: 31.4K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/shadps4-emu-shadps4) | Coming soon |
| [skills](https://github.com/mattpocock/skills) - Real Engineers' Complete Guide to the Claude Skills System | license: MIT<br>⭐ Star: 132.5K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/mattpocock-skills) | Coming soon |
| [skills](https://github.com/mattpocock/skills) - A Complete Guide to Real Engineers' Claude Skills System | license: MIT<br>⭐ Star: 132.5K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/mattpocock-skills-engineers) | Coming soon |
| [TrendRadar](https://github.com/sansan0/TrendRadar) - Architecture walkthrough for an AI coding or developer-tool project: TrendRadar. | license: GPL-3.0<br>⭐ Star: 59.5K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/sansan0-trendradar) | Coming soon |
| Ttguy0707 Cyberclaw - CyberClaw Interactive Code Walkthrough | license: Unknown<br>⭐ Star: Unknown | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/ttguy0707-cyberclaw) | Coming soon |
| [vibe coding cn](https://github.com/tukuaiai/vibe-coding-cn) - Vibe Coding Series 2 (Methodology) · Five-Layer Methodology | license: MIT<br>⭐ Star: 14.8K | Cursor, GitHub Copilot, Claude Code | [Codex](https://www.aiflowlearn.net/en/codex/vibe-coding-cn) | Coming soon |
| [worldmonitor](https://github.com/koala73/worldmonitor) - WorldMonitor: AI Real-time Global Intelligence Monitoring System | license: NOASSERTION<br>⭐ Star: 56.6K | Notion, Airtable, Zapier | [Codex](https://www.aiflowlearn.net/en/codex/koala73-worldmonitor-ai) | Coming soon |
...
| [context7](https://github.com/upstash/context7) - Architecture walkthrough for a data, RAG, search, or analytics project: context7. | license: MIT<br>⭐ Star: 57.5K | Glean, NotebookLM, Pinecone | [Codex](https://www.aiflowlearn.net/en/codex/upstash-context7) | Coming soon |
| [kweaver](https://github.com/kweaver/kweaver) - kweaver-dip Anatomy Class: The Complete Pipeline from Documents to Knowledge Graphs | license: Unknown<br>⭐ Star: Unknown | Glean, NotebookLM, Pinecone | [Codex](https://www.aiflowlearn.net/en/codex/kweaver-dip) | Coming soon |
| [LlamaFactory](https://github.com/hiyouga/LlamaFactory) - LlamaFactory: A Unified Fine-Tuning Framework for Hundreds of LLMs/VLMs | license: Apache-2.0<br>⭐ Star: 72.2K | Glean, NotebookLM, Pinecone | [Codex](https://www.aiflowlearn.net/en/codex/hiyouga-llamafactory) | Coming soon |
| [markitdown](https://github.com/microsoft/markitdown) - MarkItDown: Microsoft file-to-Markdown conversion tool | license: MIT<br>⭐ Star: 154.9K | Glean, NotebookLM, Pinecone | [Codex](https://www.aiflowlearn.net/en/codex/microsoft-markitdown) | Coming soon |
| [markitdown](https://github.com/microsoft/markitdown) - MarkItDown: The Universal Key to Converting Files to Markdown | license: MIT<br>⭐ Star: 154.9K | Glean, NotebookLM, Pinecone | [Codex](https://www.aiflowlearn.net/en/codex/microsoft-markitdown) | Coming soon |
| [ollama](https://github.com/ollama/ollama) - Ollama: A Lightweight Runtime for Running Large Models Locally | license: MIT<br>⭐ Star: 174.4K | Glean, NotebookLM, Pinecone | [Codex](https://www.aiflowlearn.net/en/codex/ollama-ollama) | Coming soon |
| [pytorch](https://github.com/pytorch/pytorch) - PyTorch: A Dynamic-Graph Deep Learning and GPU Computing Framework | license: NOASSERTION<br>⭐ Star: 100.8K | Glean, NotebookLM, Pinecone | [Codex](https://www.aiflowlearn.net/en/codex/pytorch-pytorch) | Coming soon |
| [ragflow](https://github.com/infiniflow/ragflow) - RAGFlow: An In-Depth Analysis of the Enterprise RAG Engine | license: Apache-2.0<br>⭐ Star: 83K | Glean, NotebookLM, Pinecone | [Codex](https://www.aiflowlearn.net/en/codex/ragflow-enterprise-rag) | Coming soon |
| [transformers](https://github.com/huggingface/transformers) - Transformers: Multimodal Model Definition, Inference, and Training Framework | license: Apache-2.0<br>⭐ Star: 161.7K | Glean, NotebookLM, Pinecone | [Codex](https://www.aiflowlearn.net/en/codex/huggingface-transformers) | Coming soon |
| [Understand Anything](https://github.com/lum1104/Understand-Anything) - Understand Anything: Turn a Codebase into a Queryable Knowledge Graph | license: MIT<br>⭐ Star: 62.1K | Glean, NotebookLM, Pinecone | [Codex](https://www.aiflowlearn.net/en/codex/lum1104-understand-anything) | Coming soon |
| [unsloth](https://github.com/unslothai/unsloth) - Unsloth: 2x Faster, Half the Memory for LLM Fine-tuning | license: Apache-2.0<br>⭐ Star: 66.7K | Glean, NotebookLM, Pinecone | [Codex](https://www.aiflowlearn.net/en/codex/unslothai-unsloth) | Coming soon |

### Infrastructure, LLMOps & Gateways

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [ds2api](https://github.com/CJackHwang/ds2api) - ds2api: Implementation Principles of a Multi-Protocol LLM API Gateway | license: AGPL-3.0<br>⭐ Star: 4.7K | OpenRouter, Together AI, AWS Bedrock | [Codex](https://www.aiflowlearn.net/en/codex/ds2api-llm-gateway) | Coming soon |
| [LocalAI](https://github.com/mudler/LocalAI) - LocalAI: Open-Source Engine for Running AI Models Locally | license: MIT<br>⭐ Star: 46.9K | OpenRouter, Together AI, AWS Bedrock | [Codex](https://www.aiflowlearn.net/en/codex/go-skynet-localai) | Coming soon |
| [LocalAI](https://github.com/mudler/LocalAI) - LocalAI: An Open-Source Engine for Running Text, Voice, and Vision Models Locally | license: MIT<br>⭐ Star: 46.9K | OpenRouter, Together AI, AWS Bedrock | [Codex](https://www.aiflowlearn.net/en/codex/mudler-localai) | Coming soon |
| [vllm](https://github.com/vllm-project/vllm) - vLLM: How the High-Throughput LLM Inference Engine Works | license: Apache-2.0<br>⭐ Star: 83.1K | OpenRouter, Together AI, AWS Bedrock | [Codex](https://www.aiflowlearn.net/en/codex/vllm-llm-inference-engine) | Coming soon |
| [vllm](https://github.com/vllm-project/vllm) - Deep Dive into vLLM: The Secrets of LLM Inference Engines | license: Apache-2.0<br>⭐ Star: 83.1K | OpenRouter, Together AI, AWS Bedrock | [Codex](https://www.aiflowlearn.net/en/codex/vllm-project-vllm) | Coming soon |
| [vllm](https://github.com/vllm-project/vllm) - Deep Dive into vLLM: High-Performance LLM Inference Engine | license: Apache-2.0<br>⭐ Star: 83.1K | OpenRouter, Together AI, AWS Bedrock | [Codex](https://www.aiflowlearn.net/en/codex/vllm-project-vllm-mp78cyda) | Coming soon |
| [vllm](https://github.com/vllm-project/vllm) - vLLM In-Depth: High-Performance LLM Inference Engine | license: Apache-2.0<br>⭐ Star: 83.1K | OpenRouter, Together AI, AWS Bedrock | [Codex](https://www.aiflowlearn.net/en/codex/vllm-project-vllm-mp78rfsw) | Coming soon |
...
### Research, Finance & Decision Agents

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [AI Scientist v2](https://github.com/SakanaAI/AI-Scientist-v2) - AI Scientist v2 — Deep Dive into the Fully Automated Research System | license: NOASSERTION<br>⭐ Star: 6.6K | Bloomberg Terminal, AlphaSense, FactSet | [Codex](https://www.aiflowlearn.net/en/codex/sakanaai-ai-scientist-v2) | Coming soon |
| [autoresearch](https://github.com/karpathy/autoresearch) - autoresearch: Exploring AI-Automated Scientific Research Pathways | license: Unknown<br>⭐ Star: 87.2K | Bloomberg Terminal, AlphaSense, FactSet | [Codex](https://www.aiflowlearn.net/en/codex/karpathy-autoresearch-ai) | Coming soon |
| [DeepSeek TUI](https://github.com/Hmbown/DeepSeek-TUI) - DeepSeek-TUI: AI Code Assistant in the Terminal | license: MIT<br>⭐ Star: 38.5K | Bloomberg Terminal, AlphaSense, FactSet | [Codex](https://www.aiflowlearn.net/en/codex/hmbown-deepseek-tui) | Coming soon |
| [Kronos](https://github.com/shiyu-coder/Kronos) - Kronos: Architecture Analysis of Financial Market Language Foundation Model | license: MIT<br>⭐ Star: 30.6K | Bloomberg Terminal, AlphaSense, FactSet | [Codex](https://www.aiflowlearn.net/en/codex/kronos-financial-foundation) | Coming soon |
| [last30days skill](https://github.com/mvanhorn/last30days-skill) - Last 30 Days: a 30-day AI skill research program | license: MIT<br>⭐ Star: 43.7K | Bloomberg Terminal, AlphaSense, FactSet | [Codex](https://www.aiflowlearn.net/en/codex/mvanhorn-last30days-skill) | Coming soon |

### Media, Design & Multimodal

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [ComfyUI](https://github.com/comfyanonymous/ComfyUI) - ComfyUI Internal Architecture: How the Node Graph Engine Powers the AI Creation Pipeline | license: GPL-3.0<br>⭐ Star: 117.3K | Runway, HeyGen, Canva | [Codex](https://www.aiflowlearn.net/en/codex/comfy-org-comfyui) | Coming soon |
| [fish speech](https://github.com/fishaudio/fish-speech) - Fish Speech: The Frontier of Open-Source Text-to-Speech | license: NOASSERTION<br>⭐ Star: 30.8K | Runway, HeyGen, Canva | [Codex](https://www.aiflowlearn.net/en/codex/fishaudio-fish-speech) | Coming soon |
| [gradio](https://github.com/gradio-app/gradio) - Architecture walkthrough for a media, design, or multimodal AI project: gradio. | license: Apache-2.0<br>⭐ Star: 42.9K | Runway, HeyGen, Canva | [Codex](https://www.aiflowlearn.net/en/codex/gradio-app-gradio) | Coming soon |
| [LLMs from scratch](https://github.com/rasbt/LLMs-from-scratch) - LLMs-from-scratch: A hands-on tutorial for building large language models from scratch | license: NOASSERTION<br>⭐ Star: 97.3K | Runway, HeyGen, Canva | [Codex](https://www.aiflowlearn.net/en/codex/rasbt-llms-from-scratch) | Coming soon |
| [MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) - MoneyPrinterTurbo: One-Click AI Short Video Generation | license: MIT<br>⭐ Star: 89K | Runway, HeyGen, Canva | [Codex](https://www.aiflowlearn.net/en/codex/harry0703-money-printer-turbo) | Coming soon |
| [Open Generative AI](https://github.com/Anil-matcha/Open-Generative-AI) - Open Source AI Image/Video Generation Platform Architecture Explained | license: MIT<br>⭐ Star: 19.8K | Runway, HeyGen, Canva | [Codex](https://www.aiflowlearn.net/en/codex/open-generative-ai-studio) | Coming soon |
| [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) - PaddleOCR: OCR Tool to Convert PDFs and Images to Structured Data | license: Apache-2.0<br>⭐ Star: 82.7K | Runway, HeyGen, Canva | [Codex](https://www.aiflowlearn.net/en/codex/paddlepaddle-paddleocr) | Coming soon |
| [ppt master](https://github.com/hugohe3/ppt-master) - AI-Generated Native Editable PPTX: ppt-master Source Code Analysis | license: MIT<br>⭐ Star: 28.6K | Runway, HeyGen, Canva | [Codex](https://www.aiflowlearn.net/en/codex/ppt-master-ai-slides) | Coming soon |
| [react](https://github.com/facebook/react) - React Deep Dive: From Design Philosophy to Core Implementation | license: MIT<br>⭐ Star: 246K | Runway, HeyGen, Canva | [Codex](https://www.aiflowlearn.net/en/codex/facebook-react) | Coming soon |
| [supertonic](https://github.com/supertone-inc/supertonic) - Architecture walkthrough for a media, design, or multimodal AI project: supertonic. | license: MIT<br>⭐ Star: 12.4K | Runway, HeyGen, Canva | [Codex](https://www.aiflowlearn.net/en/codex/supertone-inc-supertonic) | Coming soon |
| [VibeVoice](https://github.com/microsoft/VibeVoice) - VibeVoice · Long-form Audio Speech Generation Architecture | license: MIT<br>⭐ Star: 49.4K | Runway, HeyGen, Canva | [Codex](https://www.aiflowlearn.net/en/codex/microsoft-vibevoice) | Coming soon |

### Security, Browser & Automation

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| Gyulyvgc Sniffnet - Architecture walkthrough for a security, browser, or automation project: Gyulyvgc Sniffnet. | license: Apache-2.0 / MIT<br>⭐ Star: 39.1K | Snyk, Semgrep, Browserbase | [Codex](https://www.aiflowlearn.net/en/codex/gyulyvgc-sniffnet) | Coming soon |
| [android reverse engineering skill](https://github.com/SimoneAvogadro/android-reverse-engineering-skill) - Architecture walkthrough for a security, browser, or automation project: android reverse engineering skill. | license: Apache-2.0<br>⭐ Star: 6.1K | Snyk, Semgrep, Browserbase | [Codex](https://www.aiflowlearn.net/en/codex/simoneavogadro-android-reverse-engineering-skill) | Coming soon |
| [system prompts leaks](https://github.com/asgeirtj/system_prompts_leaks) - Architecture walkthrough for a security, browser, or automation project: system prompts leaks. | license: CC0-1.0<br>⭐ Star: 42.9K | Snyk, Semgrep, Browserbase | [Codex](https://www.aiflowlearn.net/en/codex/asgeirtj-system-prompts-leaks) | Coming soon |

### Learning Resources & Skill Collections

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [andrej karpathy skills](https://github.com/forrestchang/andrej-karpathy-skills) - Guided learning path for an open-source AI engineering resource: andrej karpathy skills. | license: Unknown<br>⭐ Star: 177.2K | Coursera, Udemy, O'Reilly | [Codex](https://www.aiflowlearn.net/en/codex/forrestchang-andrej-karpathy-skills) | Coming soon |
| [nvim treesitter](https://github.com/nvim-treesitter/nvim-treesitter) - Guided learning path for an open-source AI engineering resource: nvim treesitter. | license: Apache-2.0<br>⭐ Star: 14K | Coursera, Udemy, O'Reilly | [Codex](https://www.aiflowlearn.net/en/codex/nvim-treesitter-nvim-treesitter) | Coming soon |
| [personaplex](https://github.com/NVIDIA/personaplex) - Guided learning path for an open-source AI engineering resource: personaplex. | license: MIT<br>⭐ Star: 10K | Coursera, Udemy, O'Reilly | [Codex](https://www.aiflowlearn.net/en/codex/nvidia-personaplex) | Coming soon |
| [taste skill](https://github.com/Leonxlnx/taste-skill) - Taste Skill: anti-template frontend design guidance for AI agents | license: MIT<br>⭐ Star: 45.5K | Coursera, Udemy, O'Reilly | [Codex](https://www.aiflowlearn.net/en/codex/leonxlnx-taste-skill) | Coming soon |
...
| [CodeZero](https://open.aiflowlearn.net/codezero) - Open-source no-code automation platform for logistics, chatbots, and AI agents. | license: Unknown<br>⭐ Star: 35 | Zoho Flow, Azure Logic Apps | Coming soon | Coming soon |
| [Grepture](https://open.aiflowlearn.net/grepture) - An AI gateway that sits on the request path to handle PII redaction, prompt injection blocking, tracing,... | license: AGPL-3.0<br>⭐ Star: 7 | Vercel AI Gateway, Cloudflare AI Gateway, Kong AI Gateway | Coming soon | Coming soon |
...
| [Scira](https://open.aiflowlearn.net/scira) - Scira delivers concise, AI-generated responses to queries using a clean interface and powerful search... | license: AGPL-3.0<br>⭐ Star: 12K | - | Coming soon | Coming soon |
...
| [Swirl Search](https://open.aiflowlearn.net/swirl) - AI-powered search and RAG platform that connects to 100+ enterprise tools without data migration. | license: Apache-2.0<br>⭐ Star: 3K | Algolia, ElasticSearch, AWS Kendra | Coming soon | Coming soon |
| [Trieve](https://open.aiflowlearn.net/trieve) - Trieve offers an all-in-one solution for search, recommendations, and RAG with automatic continuous... | license: MIT<br>⭐ Star: 2.7K | Pinecone, Algolia, ElasticSearch | Coming soon | Coming soon |
| [Fullmoon](https://open.aiflowlearn.net/fullmoon) - A mobile app for interacting with private, local large language models that work offline and are optimized... | license: MIT<br>⭐ Star: 2.3K | Claude, Grok, ChatGPT | Coming soon | Coming soon |
| [Zola](https://open.aiflowlearn.net/zola) - Open-source chat application that lets you interact with multiple AI models in one interface, offering... | license: Apache-2.0<br>⭐ Star: 1.5K | Claude, Grok, ChatGPT | Coming soon | Coming soon |
| [Amical](https://open.aiflowlearn.net/amical) - Open source AI dictation app that transforms speech to text with context-aware formatting. | license: MIT<br>⭐ Star: 1.4K | Wispr Flow, Superwhisper, Otter.ai | Coming soon | Coming soon |
| [Minutes](https://open.aiflowlearn.net/minutes) - Records meetings and voice memos locally using whisper.cpp, writes structured markdown to disk, and... | license: MIT<br>⭐ Star: 1.3K | Otter.ai, Granola, Jamie AI | Coming soon | Coming soon |
| [Pearl](https://open.aiflowlearn.net/pearl) - Connect all your apps through Pearl, an AI assistant that automates workflows directly in Slack. | license: Apache-2.0<br>⭐ Star: 1.1K | - | Coming soon | Coming soon |
| [Jarvis](https://open.aiflowlearn.net/jarvis) - Free, open-source macOS voice assistant that transcribes speech, applies AI transformations, and controls... | license: MIT<br>⭐ Star: 558 | Wispr Flow, Superwhisper, Voiceflow | Coming soon | Coming soon |
| [Browser Operator](https://open.aiflowlearn.net/browser-operator) - Privacy-focused AI browser with intelligent agents for research, analysis, and workflow automation. | license: BSD-3-Clause<br>⭐ Star: 487 | Comet Browser, Browserbase, Atlas Browser | Coming soon | Coming soon |
...
| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Odoo](https://open.aiflowlearn.net/odoo) - Integrated suite of business apps covering accounting, CRM, inventory, eCommerce, HR, and project... | license: Unknown<br>⭐ Star: 52K | HubSpot, SAP, Salesforce | Coming soon | Coming soon |
| [Twenty](https://open.aiflowlearn.net/twenty) - Self-hostable CRM built for technical teams who need a fully customizable, extensible platform without... | license: AGPL-3.0<br>⭐ Star: 50K | HubSpot, Salesforce, Attio | Coming soon | Coming soon |
...
| [Erxes](https://open.aiflowlearn.net/erxes) - All-in-one solution for marketing, sales, and customer service. | license: Unknown<br>⭐ Star: 4K | HubSpot, Zendesk, Salesforce | Coming soon | Coming soon |
| [Ever Gauzy](https://open.aiflowlearn.net/ever-gauzy) - All-in-one solution for ERP, CRM, HRM, ATS, and project management to streamline your business operations | license: AGPL-3.0<br>⭐ Star: 3.7K | HubSpot, SAP, Salesforce | Coming soon | Coming soon |
| [EspoCRM](https://open.aiflowlearn.net/espocrm) - Open-source CRM software for managing customers, companies, projects and opportunities. | license: AGPL-3.0<br>⭐ Star: 3K | HubSpot, Salesforce, Attio | Coming soon | Coming soon |
| [Frappe CRM](https://open.aiflowlearn.net/frappe-crm) - A flexible and customizable CRM platform for managing contacts, deals, and customer relationships without... | license: AGPL-3.0<br>⭐ Star: 2.8K | HubSpot, Salesforce, Attio | Coming soon | Coming soon |
| [Open Mercato](https://open.aiflowlearn.net/open-mercato) - A modular CRM/ERP framework built on Next.js and TypeScript that encodes hundreds of architectural... | license: MIT<br>⭐ Star: 1.4K | SAP, Retool | Coming soon | Coming soon |
| [Relaticle](https://open.aiflowlearn.net/relaticle) - Transform customer relationships with this intuitive open-source CRM. | license: AGPL-3.0<br>⭐ Star: 1.3K | HubSpot, Salesforce, Attio | Coming soon | Coming soon |
| [Atomic CRM](https://open.aiflowlearn.net/atomic-crm) - Build a customizable CRM that matches your company's vision, designed for developers and loved by end users. | license: MIT<br>⭐ Star: 1.1K | HubSpot, Salesforce, Attio | Coming soon | Coming soon |
| [Malak](https://open.aiflowlearn.net/malak) - Open source platform for managing investor updates, KPIs, fundraising pipeline and data rooms. | license: AGPL-3.0<br>⭐ Star: 59 | Carta, Pulley, AngelList | Coming soon | Coming soon |
...
| [Ever Gauzy](https://open.aiflowlearn.net/ever-gauzy) - All-in-one solution for ERP, CRM, HRM, ATS, and project management to streamline your business operations | license: AGPL-3.0<br>⭐ Star: 3.7K | HubSpot, SAP, Salesforce | Coming soon | Coming soon |
| [Shelf](https://open.aiflowlearn.net/shelf) - Simplify asset tracking, boost productivity, and gain real-time insights with our user-friendly,... | license: AGPL-3.0<br>⭐ Star: 2.6K | - | Coming soon | Coming soon |
| [FleetBase](https://open.aiflowlearn.net/fleetbase) - Fleetbase is a comprehensive open source logistics suite offering API, TMS, driver and customer apps for... | license: AGPL-3.0<br>⭐ Star: 1.9K | - | Coming soon | Coming soon |
| [Open Mercato](https://open.aiflowlearn.net/open-mercato) - A modular CRM/ERP framework built on Next.js and TypeScript that encodes hundreds of architectural... | license: MIT<br>⭐ Star: 1.4K | SAP, Retool | Coming soon | Coming soon |
...
| [Frappe Books](https://open.aiflowlearn.net/frappe-books) - A user-friendly desktop accounting software that helps businesses manage invoices, track expenses, and... | license: AGPL-3.0<br>⭐ Star: 4.7K | Quickbooks, YNAB, Mint | Coming soon | Coming soon |
...
| [Bigcapital](https://open.aiflowlearn.net/bigcapital) - Cloud-based accounting software that streamlines bookkeeping, generates intelligent reports, and offers... | license: AGPL-3.0<br>⭐ Star: 3.7K | Quickbooks, Dext, Insightly | Coming soon | Coming soon |
| [Flexprice](https://open.aiflowlearn.net/flexprice) - A flexible billing platform that handles usage-based metering, credit management, and subscription... | license: AGPL-3.0<br>⭐ Star: 3.6K | Stripe Billing, Orb | Coming soon | Coming soon |
...
| [Autumn](https://open.aiflowlearn.net/autumn) - Simplify Stripe integration for AI startups with 3 functions, 0 webhooks. | license: Apache-2.0<br>⭐ Star: 2.6K | Stripe Billing, Recurly, Zuora | Coming soon | Coming soon |
| [OpenMeter](https://open.aiflowlearn.net/openmeter) - Open source billing platform that turns events into revenue with real-time metering, usage limits, and... | license: Apache-2.0<br>⭐ Star: 2K | Stripe Billing, Recurly, Zuora | Coming soon | Coming soon |
| [Paymenter](https://open.aiflowlearn.net/paymenter) - Automate subscriptions and manage payments with a flexible, open-source billing system designed... | license: MIT<br>⭐ Star: 1.8K | Stripe Billing, Recurly, Billsby | Coming soon | Coming soon |
| [Flowglad](https://open.aiflowlearn.net/flowglad) - Build payment systems with real-time billing state and full-stack SDK. | license: Unknown<br>⭐ Star: 1.7K | Stripe Billing, Billsby, Chargebee | Coming soon | Coming soon |
| [Meteroid](https://open.aiflowlearn.net/meteroid) - Open-source pricing and billing platform that helps SaaS companies launch, test, and scale complex billing... | license: AGPL-3.0<br>⭐ Star: 1.1K | Stripe Billing, FastSpring, Recurly | Coming soon | Coming soon |
| [SolidInvoice](https://open.aiflowlearn.net/solidinvoice) - Simple and elegant invoicing solution. | license: MIT<br>⭐ Star: 894 | Freshbooks, Quickbooks | Coming soon | Coming soon |
| [Captable](https://open.aiflowlearn.net/captable) - Comprehensive cap table software for startups to manage equity, track ownership, and facilitate... | license: AGPL-3.0<br>⭐ Star: 813 | Carta, Pulley, AngelList | Coming soon | Coming soon |
| [BillaBear](https://open.aiflowlearn.net/billabear) - BillaBear offers powerful tax management, automated workflows, and comprehensive subscription control for... | license: Unknown<br>⭐ Star: 747 | Stripe Billing, Recurly, Zuora | Coming soon | Coming soon |
...
| [UniBee](https://open.aiflowlearn.net/unibee) - Replace expensive billing solutions with open-source software. | license: AGPL-3.0<br>⭐ Star: 201 | Stripe Billing, Recurly, Zuora | Coming soon | Coming soon |
| [Suprascribe](https://open.aiflowlearn.net/suprascribe) - Free subscription tracker that automatically scans your email to find recurring charges. | license: Unknown<br>⭐ Star: 7 | Rocket Money, Orbit, PocketGuard | Coming soon | Coming soon |
...
| --- | --- | --- | --- | --- |
| [Ever Gauzy](https://open.aiflowlearn.net/ever-gauzy) - All-in-one solution for ERP, CRM, HRM, ATS, and project management to streamline your business operations | license: AGPL-3.0<br>⭐ Star: 3.7K | HubSpot, SAP, Salesforce | Coming soon | Coming soon |
| [Horilla](https://open.aiflowlearn.net/horilla) - Horilla is a free, open-source HRMS that streamlines HR processes, from recruitment to offboarding, with... | license: LGPL-2.1<br>⭐ Star: 1.2K | Workable, Greenhouse, Ashby | Coming soon | Coming soon |
| [Reqcore](https://open.aiflowlearn.net/reqcore) - Self-hosted open-source ATS with no per-seat pricing. | license: AGPL-3.0<br>⭐ Star: 32 | Workable, Greenhouse, Ashby | Coming soon | Coming soon |
...
| [Krayin](https://open.aiflowlearn.net/krayin) - Open source customer relationship management platform with sales tracking, marketing automation, and... | license: MIT<br>⭐ Star: 23K | HubSpot, Salesforce, Attio | Coming soon | Coming soon |
| [Listmonk](https://open.aiflowlearn.net/listmonk) - Send email campaigns and transactional messages to millions of subscribers with a single high-performance... | license: AGPL-3.0<br>⭐ Star: 22K | Resend, Substack, Mailchimp | Coming soon | Coming soon |
...
| [Erxes](https://open.aiflowlearn.net/erxes) - All-in-one solution for marketing, sales, and customer service. | license: Unknown<br>⭐ Star: 4K | HubSpot, Zendesk, Salesforce | Coming soon | Coming soon |
| [LinkStack](https://open.aiflowlearn.net/linkstack) - A free, open-source link management platform for creating customizable, self-hosted link pages to showcase... | license: AGPL-3.0<br>⭐ Star: 3.6K | LinkTree, Bento.me, Bio.fm | Coming soon | Coming soon |
| [Chaskiq](https://open.aiflowlearn.net/chaskiq) - Versatile messaging solution for businesses to engage customers through multiple channels, with AI-powered... | license: Unknown<br>⭐ Star: 3.5K | Manychat, Zendesk, Intercom | Coming soon | Coming soon |
| [Mixpost](https://open.aiflowlearn.net/mixpost) - Create, schedule, and manage social media content from your own server with no subscription fees or usage... | license: MIT<br>⭐ Star: 3.3K | HootSuite, Buffer, Typefully | Coming soon | Coming soon |
| [Frappe Helpdesk](https://open.aiflowlearn.net/frappe-helpdesk) - Frappe Helpdesk consolidates customer issues, automates workflows, and empowers self-service to boost... | license: AGPL-3.0<br>⭐ Star: 3.2K | Zendesk, FreshDesk, Hiver | Coming soon | Coming soon |
| [LittleLink](https://open.aiflowlearn.net/littlelink) - Open source DIY alternative to Linktree with 100+ branded buttons, multiple themes, and optimized performance. | license: MIT<br>⭐ Star: 3K | LinkTree, Bento.me, Bio.fm | Coming soon | Coming soon |
| [Dittofeed](https://open.aiflowlearn.net/dittofeed) - Dittofeed offers low-code tools for message automation across multiple channels, including powerful... | license: MIT<br>⭐ Star: 2.8K | Mailchimp, Customer.io, Brevo | Coming soon | Coming soon |
...
| [OpenSEO](https://open.aiflowlearn.net/openseo) - Manage keyword research, backlink analysis, competitor monitoring, and rank tracking without expensive... | license: MIT<br>⭐ Star: 2.2K | Ahrefs, Semrush, Ubersuggest | Coming soon | Coming soon |
| [Keila](https://open.aiflowlearn.net/keila) - Self-hosted newsletter platform with powerful features, data protection, and full control over your... | license: AGPL-3.0<br>⭐ Star: 2.1K | Substack, Mailchimp, SendGrid | Coming soon | Coming soon |
| [Sendportal](https://open.aiflowlearn.net/sendportal) - Open-source email marketing platform offering unlimited subscribers, campaigns, and workspaces. | license: MIT<br>⭐ Star: 2.1K | Resend, Mailchimp, SendGrid | Coming soon | Coming soon |
| [Sendune](https://open.aiflowlearn.net/sendune) - A comprehensive platform for managing transactional and marketing emails through AWS SES, featuring... | license: MIT<br>⭐ Star: 2.1K | Resend, Mailchimp, SendGrid | Coming soon | Coming soon |
| [Usertour](https://open.aiflowlearn.net/usertour) - Open-source platform for building interactive product tours, tooltips, and in-app guides to improve user... | license: AGPL-3.0<br>⭐ Star: 2.1K | Userflow, Appcues | Coming soon | Coming soon |
| [Notifuse](https://open.aiflowlearn.net/notifuse) - Free open-source email platform for newsletters and transactional emails. | license: Unknown<br>⭐ Star: 2K | Resend, Substack, Mailchimp | Coming soon | Coming soon |
| [Linky](https://open.aiflowlearn.net/linky) - Build a dynamic link-in-bio page with a drag-and-drop editor. | license: MIT<br>⭐ Star: 791 | LinkTree, Bento.me, Bio.fm | Coming soon | Coming soon |
| [Contentport](https://open.aiflowlearn.net/contentport) - Create, schedule & manage Twitter content at scale with AI assistance, beautiful visuals, and... | license: AGPL-3.0<br>⭐ Star: 763 | Post Bridge, Postel, Hypefury | Coming soon | Coming soon |
| [Cossistant](https://open.aiflowlearn.net/cossistant) - Open-source support platform combining AI and human agents. | license: AGPL-3.0<br>⭐ Star: 677 | Zendesk, Intercom, Pylon | Coming soon | Coming soon |
| [Lua.sh](https://open.aiflowlearn.net/lua-sh) - Open-source platform for creating shortened URLs with advanced analytics, custom domains, and API... | license: AGPL-3.0<br>⭐ Star: 333 | TinyURL, Bitly, Short.io | Coming soon | Coming soon |
| [Tiledesk](https://open.aiflowlearn.net/tiledesk) - AI-enhanced live chat platform for seamless customer engagement, featuring chatbots, multichannel support,... | license: MIT<br>⭐ Star: 321 | Manychat, Voiceflow, Chatbase | Coming soon | Coming soon |
| [TryPost](https://open.aiflowlearn.net/trypost) - Plan, schedule, and auto-publish social media content across 10+ networks with a visual calendar, AI... | license: AGPL-3.0<br>⭐ Star: 269 | HootSuite, Buffer, Typefully | Coming soon | Coming soon |
| [Brace.to](https://open.aiflowlearn.net/brace-to) - A privacy-focused bookmark manager that encrypts your saved links, allowing you to access them anytime,... | license: MIT<br>⭐ Star: 103 | Pocket, Raindrop, Omnivore | Coming soon | Coming soon |
| [Slugy](https://open.aiflowlearn.net/slugy) - Open-source URL shortener with analytics, custom domains, QR codes, and link-in-bio pages. | license: MIT<br>⭐ Star: 90 | TinyURL, Bitly, Short.io | Coming soon | Coming soon |
| [Wraps](https://open.aiflowlearn.net/wraps) - Build email templates as React components and automations in TypeScript. | license: Unknown<br>⭐ Star: 46 | Resend, Customer.io, SendGrid | Coming soon | Coming soon |
| [Hyvor Post](https://open.aiflowlearn.net/hyvor-post) - Create and send newsletters with complete privacy protection. | license: AGPL-3.0<br>⭐ Star: 31 | Resend, Mailchimp, SendGrid | Coming soon | Coming soon |
...
| [Frappe Helpdesk](https://open.aiflowlearn.net/frappe-helpdesk) - Frappe Helpdesk consolidates customer issues, automates workflows, and empowers self-service to boost... | license: AGPL-3.0<br>⭐ Star: 3.2K | Zendesk, FreshDesk, Hiver | Coming soon | Coming soon |
| [Usertour](https://open.aiflowlearn.net/usertour) - Open-source platform for building interactive product tours, tooltips, and in-app guides to improve user... | license: AGPL-3.0<br>⭐ Star: 2.1K | Userflow, Appcues | Coming soon | Coming soon |
| [LogChimp](https://open.aiflowlearn.net/logchimp) - Collect, organize, and prioritize user feedback to build better products. | license: Apache-2.0<br>⭐ Star: 1.1K | Featurebase, ProductBoard, Canny | Coming soon | Coming soon |
| [Cossistant](https://open.aiflowlearn.net/cossistant) - Open-source support platform combining AI and human agents. | license: AGPL-3.0<br>⭐ Star: 677 | Zendesk, Intercom, Pylon | Coming soon | Coming soon |
| [ClearFlask](https://open.aiflowlearn.net/clearflask) - ClearFlask is an open-source platform for collecting, analyzing, and acting on customer feedback to drive... | license: Apache-2.0<br>⭐ Star: 440 | Featurebase, ProductBoard, Canny | Coming soon | Coming soon |
| [Tiledesk](https://open.aiflowlearn.net/tiledesk) - AI-enhanced live chat platform for seamless customer engagement, featuring chatbots, multichannel support,... | license: MIT<br>⭐ Star: 321 | Manychat, Voiceflow, Chatbase | Coming soon | Coming soon |
| [SAMA](https://open.aiflowlearn.net/sama) - Open source chat server with end-to-end encryption, clustering support, and comprehensive messaging... | license: GPL-3.0<br>⭐ Star: 156 | Discord, Microsoft Teams, Slack | Coming soon | Coming soon |
| [UserTourKit](https://open.aiflowlearn.net/usertourkit) - Headless React tour library with WCAG 2.1 AA accessibility, TypeScript support, and pre-styled components. | license: MIT<br>⭐ Star: 47 | Userflow, Appcues | Coming soon | Coming soon |
| [Reflet](https://open.aiflowlearn.net/reflet) - Collect feedback, prioritize with AI-powered voting, and share transparent roadmaps. | license: Unknown<br>⭐ Star: 25 | Featurebase, ProductBoard, Canny | Coming soon | Coming soon |

### E-commerce Platforms

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Medusa](https://open.aiflowlearn.net/medusa) - Flexible, customizable e-commerce platform with headless architecture, built-in features, and extensive... | license: MIT<br>⭐ Star: 34K | Shopify, Adobe Commerce, Sellfy | Coming soon | Coming soon |
| [Bagisto](https://open.aiflowlearn.net/bagisto) - A flexible eCommerce platform built on Laravel that enables businesses to create marketplaces, mobile... | license: MIT<br>⭐ Star: 27K | Shopify, Magento, WooCommerce | Coming soon | Coming soon |
...
| [Wekan](https://open.aiflowlearn.net/wekan) - Open-source Kanban board solution offering visual task management, self-hosting capabilities, and robust... | license: MIT<br>⭐ Star: 21K | Monday, Jira, ClickUp | Coming soon | Coming soon |
...
| [Kaneo](https://open.aiflowlearn.net/kaneo) - Self-hosted project management platform with visual task management, data privacy, and complete control... | license: MIT<br>⭐ Star: 3.7K | Linear, Monday, Jira | Coming soon | Coming soon |
| [Worklenz](https://open.aiflowlearn.net/worklenz) - Worklenz is a comprehensive project management platform that helps agencies organize tasks, track... | license: AGPL-3.0<br>⭐ Star: 3.1K | Linear, Monday, Jira | Coming soon | Coming soon |
| [Donetick](https://open.aiflowlearn.net/donetick) - Organize tasks and chores with intelligent scheduling, fair assignment, and collaboration features. | license: AGPL-3.0<br>⭐ Star: 2.2K | Todoist, TickTick, Google Tasks | Coming soon | Coming soon |
| [Kanri](https://open.aiflowlearn.net/kanri) - Kanri is a free, open-source personal Kanban app that works offline, offering a modern and simple... | license: GPL-3.0<br>⭐ Star: 1.9K | Monday, Jira, ClickUp | Coming soon | Coming soon |
| [Freeter](https://open.aiflowlearn.net/freeter) - Organize projects, tasks, and resources in customizable workspaces. | license: GPL-3.0<br>⭐ Star: 1K | Monday, ClickUp, Todoist | Coming soon | Coming soon |
| [Taiga](https://open.aiflowlearn.net/taiga) - Taiga is an intuitive project management tool for cross-functional agile teams, offering Kanban, Scrum,... | license: MPL-2.0<br>⭐ Star: 836 | Monday, Jira, ClickUp | Coming soon | Coming soon |
| [Kanba](https://open.aiflowlearn.net/kanba) - Organize projects with intuitive Kanban boards, powered by Supabase backend and Stripe payment processing... | license: MIT<br>⭐ Star: 628 | Monday, Jira, ClickUp | Coming soon | Coming soon |
| [Ever Teams](https://open.aiflowlearn.net/ever-teams) - Ever Teams offers an all-in-one solution for work management, time tracking, and team collaboration with... | license: AGPL-3.0<br>⭐ Star: 509 | Linear, Monday, Jira | Coming soon | Coming soon |
| [Operately](https://open.aiflowlearn.net/operately) - Operately is an open source platform that centralizes projects, goals, and processes, helping startups run... | license: Apache-2.0<br>⭐ Star: 476 | Linear, Monday, Jira | Coming soon | Coming soon |
| [Shelve](https://open.aiflowlearn.net/shelve) - Shelve is a comprehensive project management tool designed to streamline workflows and enhance... | license: Apache-2.0<br>⭐ Star: 425 | Doppler, Keeper | Coming soon | Coming soon |
| [ShipShipShip](https://open.aiflowlearn.net/shipshipship) - Self-hostable changelog and roadmap platform with community voting, automated newsletters, and kanban boards. | license: Apache-2.0<br>⭐ Star: 291 | Featurebase, ProductBoard, Canny | Coming soon | Coming soon |
| [Orgnise](https://open.aiflowlearn.net/orgnise) - A versatile project management platform that combines task organization, team collaboration, and workflow... | license: AGPL-3.0<br>⭐ Star: 241 | Notion, Obsidian, Linear | Coming soon | Coming soon |
| [Manage](https://open.aiflowlearn.net/manage) - A self-hosted project management tool offering task management, file sharing, event tracking, and team... | license: AGPL-3.0<br>⭐ Star: 65 | Linear, Monday, Jira | Coming soon | Coming soon |
| [Windshift](https://open.aiflowlearn.net/windshift) - Self-hosted, open-source project management tool with boards, milestones, portals, time tracking, and test... | license: AGPL-3.0<br>⭐ Star: 24 | Linear, Jira, ClickUp | Coming soon | Coming soon |
| [Mimrai](https://open.aiflowlearn.net/mimrai) - Open source minimalist task management tool with AI companion that filters noise, automates coordination,... | license: AGPL-3.0<br>⭐ Star: 22 | Linear, Monday, Jira | Coming soon | Coming soon |
| [Sayr](https://open.aiflowlearn.net/sayr) - Source-available project management platform with dual views - internal team workspace and public portal... | license: Unknown<br>⭐ Star: 17 | Linear, Monday, ClickUp | Coming soon | Coming soon |
...
| [Focalboard](https://open.aiflowlearn.net/focalboard) - Self-hostable project management tool with Kanban boards, calendars, and table views, built for teams... | license: Unknown<br>⭐ Star: 26K | Linear, Monday, Jira | Coming soon | Coming soon |
| [Huly](https://open.aiflowlearn.net/huly) - Combines project management, team chat, virtual office, and collaborative docs into a single platform. | license: EPL-2.0<br>⭐ Star: 26K | Notion, Linear, Monday | Coming soon | Coming soon |
| [Zulip](https://open.aiflowlearn.net/zulip) - Zulip is an open-source team chat app that uses threaded conversations to keep communication organized and... | license: Apache-2.0<br>⭐ Star: 25K | Microsoft Teams, Slack, Twist | Coming soon | Coming soon |
...
| [Colanode](https://open.aiflowlearn.net/colanode) - Local-first collaboration platform combining real-time chat, rich text pages, databases, and file... | license: Apache-2.0<br>⭐ Star: 4.9K | Notion, Microsoft Teams, Confluence | Coming soon | Coming soon |
| [Campfire](https://open.aiflowlearn.net/campfire) - Install your own group chat system with @mentions, DMs, and mobile support. | license: MIT<br>⭐ Star: 4.4K | Microsoft Teams, Slack, Twist | Coming soon | Coming soon |
| [LibreOffice](https://open.aiflowlearn.net/libreoffice) - Complete free office suite compatible with Microsoft formats (.doc, .docx, .xls, .xlsx, .ppt, .pptx). | license: GPL-3.0<br>⭐ Star: 4K | Microsoft 365, Microsoft Word, Microsoft Office | Coming soon | Coming soon |
...
| [Quiet](https://open.aiflowlearn.net/quiet) - Quiet is a peer-to-peer messaging app that syncs messages directly between devices over Tor, with no... | license: GPL-3.0<br>⭐ Star: 2.6K | Discord, Slack, Telegram | Coming soon | Coming soon |
| [Wire](https://open.aiflowlearn.net/wire) - A comprehensive collaboration platform offering end-to-end encrypted messaging, file sharing, and video... | license: GPL-3.0<br>⭐ Star: 2.5K | Discord, Microsoft Teams, Slack | Coming soon | Coming soon |
| [UnInbox](https://open.aiflowlearn.net/uninbox) - Streamline team communication with shared inboxes, unlimited email addresses, and customizable workflows. | license: Unknown<br>⭐ Star: 1.7K | Microsoft Teams, Gmail, Front | Coming soon | Coming soon |
| [Mezon](https://open.aiflowlearn.net/mezon) - Build your own community space for gaming, chatting, and hanging out with friends worldwide. | license: Unknown<br>⭐ Star: 1.5K | Discord, Microsoft Teams, Slack | Coming soon | Coming soon |
...
| [Ethora](https://open.aiflowlearn.net/ethora) - Build branded chat apps with AI agents, group messaging, document exchange, and digital wallets using... | license: Apache-2.0<br>⭐ Star: 536 | Stream, Sendbird | Coming soon | Coming soon |
| [Ever Teams](https://open.aiflowlearn.net/ever-teams) - Ever Teams offers an all-in-one solution for work management, time tracking, and team collaboration with... | license: AGPL-3.0<br>⭐ Star: 509 | Linear, Monday, Jira | Coming soon | Coming soon |
| [dDocs](https://open.aiflowlearn.net/ddocs) - Write, organize, and collaborate in real-time with complete privacy and security. | license: AGPL-3.0<br>⭐ Star: 274 | Microsoft Word, Google Docs | Coming soon | Coming soon |
| [Twake Chat](https://open.aiflowlearn.net/twake-chat) - Free Matrix-based messenger with end-to-end encryption, multi-platform bridges, and on-premise deployment. | license: AGPL-3.0<br>⭐ Star: 159 | Microsoft Teams, Slack, Skype | Coming soon | Coming soon |

### Scheduling & Event Management

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Cal.com](https://open.aiflowlearn.net/cal-com) - Cal.diy is the community edition of Cal.com for personal self-hosting, with calendar sync, video... | license: MIT<br>⭐ Star: 45K | Calendly, Doodle, Savvycal | Coming soon | Coming soon |
| [Rallly](https://open.aiflowlearn.net/rallly) - A user-friendly, open-source tool for coordinating events and meetings without the hassle of... | license: AGPL-3.0<br>⭐ Star: 5.1K | Calendly, Doodle, Savvycal | Coming soon | Coming soon |
| [Easy!Appointments](https://open.aiflowlearn.net/easy-appointments) - Self-hosted appointment scheduling solution with Google Calendar sync, customizable workflows, and no... | license: GPL-3.0<br>⭐ Star: 4.2K | Calendly, Doodle, Savvycal | Coming soon | Coming soon |
| [Hi.Events](https://open.aiflowlearn.net/hi-events) - Hi.Events is a comprehensive platform for event management and online ticket sales, offering features like... | license: Unknown<br>⭐ Star: 3.9K | - | Coming soon | Coming soon |
| [Chobble Tickets](https://open.aiflowlearn.net/chobble-tickets) - Event ticketing platform with flat £50/year fee, no commission or booking charges. | license: Unknown<br>⭐ Star: 11 | - | Coming soon | Coming soon |
...
| [Ikiform](https://open.aiflowlearn.net/ikiform) - Build beautiful, interactive forms with AI assistance. | license: MIT<br>⭐ Star: 347 | Google Forms, Tally, Typeform | Coming soon | Coming soon |
| [Formizee](https://open.aiflowlearn.net/formizee) - Formizee is an open-source platform for designing, building, and analyzing forms, offering an affordable... | license: Apache-2.0<br>⭐ Star: 182 | Google Forms, Tally, Typeform | Coming soon | Coming soon |
| [Palform](https://open.aiflowlearn.net/palform) - Build end-to-end encrypted forms with enterprise-grade features, no coding required. | license: AGPL-3.0<br>⭐ Star: 44 | Google Forms, Typeform, Jotform | Coming soon | Coming soon |
...
| [c15t](https://open.aiflowlearn.net/c15t) - Open source consent management framework for modern web apps. | license: Apache-2.0<br>⭐ Star: 1.8K | Termly, CookieYes, Cookie Control | Coming soon | Coming soon |
| [Comp AI](https://open.aiflowlearn.net/comp) - AI-driven compliance platform that automates evidence collection, policy generation, and continuous... | license: AGPL-3.0<br>⭐ Star: 1.6K | Vanta, Drata, Scrut | Coming soon | Coming soon |
| [Probo](https://open.aiflowlearn.net/probo) - Compliance management platform where dedicated compliance officers handle your entire program, from risk... | license: MIT<br>⭐ Star: 1.2K | Vanta, Drata, Scrut | Coming soon | Coming soon |
| [Titan](https://open.aiflowlearn.net/titan) - Streamline role-based access control, enforce security policies, and ensure compliance for your Snowflake... | license: Apache-2.0<br>⭐ Star: 482 | Snowflake, BigQuery, RedShift | Coming soon | Coming soon |
| [VerifyWise](https://open.aiflowlearn.net/verifywise) - Open-source AI governance platform helping teams meet regulatory standards like EU AI Act and ISO 42001. | license: AGPL-3.0<br>⭐ Star: 304 | Vanta, Drata, Scrut | Coming soon | Coming soon |
| [Openlane](https://open.aiflowlearn.net/openlane) - Automates evidence collection, control tracking, and audit reporting across SOC 2, ISO 27001, NIST 800-53,... | license: Apache-2.0<br>⭐ Star: 261 | Vanta, Drata, Scrut | Coming soon | Coming soon |
| [OpenPolicy](https://open.aiflowlearn.net/openpolicy) - Open-source policy-as-code framework that lets developers create privacy policies, terms of service, and... | license: Apache-2.0<br>⭐ Star: 153 | Termly, iubenda | Coming soon | Coming soon |
...
| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Mastodon](https://open.aiflowlearn.net/mastodon) - A free, open-source social media platform that puts users in charge of their data and connections | license: AGPL-3.0<br>⭐ Star: 50K | Facebook, X (Twitter), Threads | Coming soon | Coming soon |
| [Hey](https://open.aiflowlearn.net/hey) - A blockchain-powered social platform offering censorship-resistant content sharing, user-owned data, and... | license: GPL-3.0<br>⭐ Star: 29K | X (Twitter), Threads | Coming soon | Coming soon |
...
| [Loops](https://open.aiflowlearn.net/loops) - Open-source, decentralized short-video platform that gives creators control. | license: AGPL-3.0<br>⭐ Star: 417 | YouTube, Instagram, Facebook | Coming soon | Coming soon |

### Community Building Platforms

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Discourse](https://open.aiflowlearn.net/discourse) - A powerful, customizable platform for building and managing online forums, fostering engaging discussions... | license: GPL-2.0<br>⭐ Star: 47K | Skool, Circle, Invision Community | Coming soon | Coming soon |
| [Apache Answer](https://open.aiflowlearn.net/apache-answer) - A versatile, community-driven Q&A platform that fosters collaboration and knowledge exchange within... | license: Apache-2.0<br>⭐ Star: 16K | Skool, Circle, vBulletin | Coming soon | Coming soon |
| [Flarum](https://open.aiflowlearn.net/flarum) - Lightweight, extensible forum platform with a sleek interface, powerful moderation tools, and seamless... | license: MIT<br>⭐ Star: 16K | Skool, Circle, Invision Community | Coming soon | Coming soon |
...
| [Storyden](https://open.aiflowlearn.net/storyden) - Create permanent, discoverable communities with modern forum features. | license: MPL-2.0<br>⭐ Star: 312 | Skool, Circle, Invision Community | Coming soon | Coming soon |
...
| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Strapi](https://open.aiflowlearn.net/strapi) - A powerful headless CMS that enables developers to build, deploy, and manage content-rich applications... | license: Unknown<br>⭐ Star: 72K | Sanity, Contentful | Coming soon | Coming soon |
| [Ghost](https://open.aiflowlearn.net/ghost) - Publish content, send email newsletters, and sell paid subscriptions from one platform. | license: MIT<br>⭐ Star: 54K | WordPress, Substack, Sanity | Coming soon | Coming soon |
| [Payload](https://open.aiflowlearn.net/payload) - A powerful, flexible, and developer-friendly content management system that prioritizes customization and... | license: MIT<br>⭐ Star: 43K | WordPress, Sanity, Contentful | Coming soon | Coming soon |
...
| [Twill CMS](https://open.aiflowlearn.net/twill-cms) - A powerful, open-source CMS for Laravel that simplifies content management with a modular approach and... | license: Apache-2.0<br>⭐ Star: 4K | WordPress, Sanity, Contentful | Coming soon | Coming soon |
| [Craft CMS](https://open.aiflowlearn.net/craft-cms) - Build custom websites with a user-friendly CMS that puts content first. | license: Unknown<br>⭐ Star: 3.6K | WordPress, Sanity, Contentful | Coming soon | Coming soon |
...
| [ProcessWire](https://open.aiflowlearn.net/processwire) - A versatile, open-source content management system with a powerful API, modular architecture, and... | license: Unknown<br>⭐ Star: 1.1K | WordPress, Sanity | Coming soon | Coming soon |
...
| [Typemill](https://open.aiflowlearn.net/typemill) - Create manuals, documentation, and websites with this markdown-based content management system, with... | license: MIT<br>⭐ Star: 599 | Confluence, WordPress | Coming soon | Coming soon |
| [Marble CMS](https://open.aiflowlearn.net/marble-cms) - A headless CMS designed for blogs, changelogs, and articles. | license: AGPL-3.0<br>⭐ Star: 368 | WordPress, Sanity, Contentful | Coming soon | Coming soon |
...
| [Apache Answer](https://open.aiflowlearn.net/apache-answer) - A versatile, community-driven Q&A platform that fosters collaboration and knowledge exchange within... | license: Apache-2.0<br>⭐ Star: 16K | Skool, Circle, vBulletin | Coming soon | Coming soon |
| [Flarum](https://open.aiflowlearn.net/flarum) - Lightweight, extensible forum platform with a sleek interface, powerful moderation tools, and seamless... | license: MIT<br>⭐ Star: 16K | Skool, Circle, Invision Community | Coming soon | Coming soon |
| [Valour](https://open.aiflowlearn.net/valour) - Open-source communication platform with multi-window chat, economy systems, and privacy-first approach. | license: AGPL-3.0<br>⭐ Star: 386 | Discord, Slack, Guilded | Coming soon | Coming soon |
| [Storyden](https://open.aiflowlearn.net/storyden) - Create permanent, discoverable communities with modern forum features. | license: MPL-2.0<br>⭐ Star: 312 | Skool, Circle, Invision Community | Coming soon | Coming soon |
...
| [Fumadocs](https://open.aiflowlearn.net/fumadocs) - A flexible Next.js framework for creating stunning documentation sites with MDX support, built-in search,... | license: MIT<br>⭐ Star: 12K | Mintlify, Gitbook | Coming soon | Coming soon |
| [Firecamp](https://open.aiflowlearn.net/firecamp) - All-in-one platform for API testing, documentation, and collaboration, simplifying the entire API... | license: AGPL-3.0<br>⭐ Star: 2.6K | Postman, Testfully | Coming soon | Coming soon |
...
| [XWiki](https://open.aiflowlearn.net/xwiki) - XWiki is a flexible, feature-rich wiki software that helps organizations structure and share knowledge... | license: LGPL-2.1<br>⭐ Star: 1.3K | Notion, Obsidian, Confluence | Coming soon | Coming soon |
| [Typemill](https://open.aiflowlearn.net/typemill) - Create manuals, documentation, and websites with this markdown-based content management system, with... | license: MIT<br>⭐ Star: 599 | Confluence, WordPress | Coming soon | Coming soon |
| [Storyden](https://open.aiflowlearn.net/storyden) - Create permanent, discoverable communities with modern forum features. | license: MPL-2.0<br>⭐ Star: 312 | Skool, Circle, Invision Community | Coming soon | Coming soon |
| [Changes.Page](https://open.aiflowlearn.net/changes-page) - Automate and simplify changelog generation from Git commits, ensuring clear and consistent project... | license: AGPL-3.0<br>⭐ Star: 284 | ProductBoard, Canny, Nolt | Coming soon | Coming soon |
| [Zenblog](https://open.aiflowlearn.net/zenblog) - A minimalist, markdown-based blogging platform designed for developers, featuring syntax highlighting and... | license: AGPL-3.0<br>⭐ Star: 252 | WordPress, Substack, Beehiiv | Coming soon | Coming soon |
| [xyd](https://open.aiflowlearn.net/xyd) - Create powerful, interactive documentation with hot reloading, TypeScript support, custom components, and... | license: MIT<br>⭐ Star: 109 | Mintlify, Gitbook | Coming soon | Coming soon |
| [Corpus](https://open.aiflowlearn.net/corpus) - Upload files, ask questions, and get AI‑backed answers with citations. | license: AGPL-3.0<br>⭐ Star: 13 | - | Coming soon | Coming soon |
...
| [TechBlitz](https://open.aiflowlearn.net/techblitz) - Learn to code through interactive challenges, personalized learning paths, and AI-powered assistance | license: Apache-2.0<br>⭐ Star: 432 | Udemy, Coursera, LeetCode | Coming soon | Coming soon |

### Digital Asset Management (DAM)

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Immich](https://open.aiflowlearn.net/immich) - Back up, organize, search, and browse your personal photo and video library on your own server, with no... | license: AGPL-3.0<br>⭐ Star: 103K | Google Photos, Apple Photos | Coming soon | Coming soon |
...
| [Lychee](https://open.aiflowlearn.net/lychee) - Free photo management tool that runs on your server. | license: MIT<br>⭐ Star: 4.2K | Google Photos, Apple Photos | Coming soon | Coming soon |
| [Piwigo](https://open.aiflowlearn.net/piwigo) - Open source photo management software for organizing, sharing and managing large photo libraries. | license: GPL-2.0<br>⭐ Star: 3.8K | Google Photos, Apple Photos | Coming soon | Coming soon |
| [Openinary](https://open.aiflowlearn.net/openinary) - Open-source alternative to Cloudinary offering self-hosted media transformation. | license: AGPL-3.0<br>⭐ Star: 334 | Cloudinary, ImageKit, Acquia DAM | Coming soon | Coming soon |

### Publishing

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [LibreTranslate](https://open.aiflowlearn.net/libretranslate) - Self-hosted machine translation API that works offline. | license: AGPL-3.0<br>⭐ Star: 15K | - | Coming soon | Coming soon |
| [Weblate](https://open.aiflowlearn.net/weblate) - Web-based continuous localization platform with version control integration, quality checks, and clean... | license: GPL-3.0<br>⭐ Star: 5.9K | Crowdin, Lokalise, Weglot | Coming soon | Coming soon |
| [Lingo.dev](https://open.aiflowlearn.net/lingo) - Transform your app into a global product with AI-powered localization that integrates directly into your... | license: Apache-2.0<br>⭐ Star: 5.4K | Crowdin, Lokalise, Weglot | Coming soon | Coming soon |
| [Tolgee](https://open.aiflowlearn.net/tolgee) - Manage app translations with in-context editing, AI translation, and collaborative tools. | license: Unknown<br>⭐ Star: 4K | Crowdin, Lokalise, Weglot | Coming soon | Coming soon |
| [Languine](https://open.aiflowlearn.net/languine) - A developer-focused localization platform that automates translation workflows within your existing... | license: MIT<br>⭐ Star: 2K | Crowdin, Lokalise, Weglot | Coming soon | Coming soon |
| [ShipShipShip](https://open.aiflowlearn.net/shipshipship) - Self-hostable changelog and roadmap platform with community voting, automated newsletters, and kanban boards. | license: Apache-2.0<br>⭐ Star: 291 | Featurebase, ProductBoard, Canny | Coming soon | Coming soon |
| [Changes.Page](https://open.aiflowlearn.net/changes-page) - Automate and simplify changelog generation from Git commits, ensuring clear and consistent project... | license: AGPL-3.0<br>⭐ Star: 284 | ProductBoard, Canny, Nolt | Coming soon | Coming soon |
...
| [Ghost](https://open.aiflowlearn.net/ghost) - Publish content, send email newsletters, and sell paid subscriptions from one platform. | license: MIT<br>⭐ Star: 54K | WordPress, Substack, Sanity | Coming soon | Coming soon |
| [WordPress](https://open.aiflowlearn.net/wordpress) - A versatile, user-friendly platform for building and managing websites, from simple blogs to complex... | license: Unknown<br>⭐ Star: 21K | Substack, Framer, Squarespace | Coming soon | Coming soon |
| [Sigle](https://open.aiflowlearn.net/sigle) - Sigle is a secure, open-source platform for Web3 writers to create, publish, and monetize content on the... | license: MIT<br>⭐ Star: 486 | Substack, Beehiiv, Medium | Coming soon | Coming soon |
| [Zenblog](https://open.aiflowlearn.net/zenblog) - A minimalist, markdown-based blogging platform designed for developers, featuring syntax highlighting and... | license: AGPL-3.0<br>⭐ Star: 252 | WordPress, Substack, Beehiiv | Coming soon | Coming soon |
| [Pagecord](https://open.aiflowlearn.net/pagecord) - Share your thoughts and ideas with an independent platform that combines microblogging, journaling, and... | license: MIT<br>⭐ Star: 175 | WordPress, Substack, Medium | Coming soon | Coming soon |
...
| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Umami](https://open.aiflowlearn.net/umami) - A lightweight, open-source alternative to Google Analytics that respects user privacy and provides... | license: MIT<br>⭐ Star: 37K | Google Analytics, Cloudflare Analytics, Mixpanel | Coming soon | Coming soon |
| [PostHog](https://open.aiflowlearn.net/posthog) - All-in-one product analytics platform. | license: Unknown<br>⭐ Star: 35K | Google Analytics, Cloudflare Analytics, Mixpanel | Coming soon | Coming soon |
| [Plausible](https://open.aiflowlearn.net/plausible) - Simple, open-source web analytics tool that respects user privacy and provides valuable insights without... | license: AGPL-3.0<br>⭐ Star: 27K | Google Analytics, Cloudflare Analytics, Mixpanel | Coming soon | Coming soon |
...
| [Aptabase](https://open.aiflowlearn.net/aptabase) - Open-source, self-hostable analytics platform for mobile and desktop apps, prioritizing user privacy and... | license: AGPL-3.0<br>⭐ Star: 1.7K | Google Analytics, Mixpanel, Amplitude | Coming soon | Coming soon |
| [Litlyx](https://open.aiflowlearn.net/litlyx) - Track user behavior, custom events, and conversion funnels in real-time with a single line of code, all... | license: Apache-2.0<br>⭐ Star: 1.7K | Google Analytics, Cloudflare Analytics, Mixpanel | Coming soon | Coming soon |
...
| [Databuddy](https://open.aiflowlearn.net/databuddy) - Get powerful web analytics with zero cookies, 100% GDPR compliance, and full data ownership. | license: AGPL-3.0<br>⭐ Star: 1.1K | Google Analytics, Cloudflare Analytics, Mixpanel | Coming soon | Coming soon |
| [Swetrix](https://open.aiflowlearn.net/swetrix) - Open-source web analytics platform offering powerful insights while prioritizing user privacy and data... | license: AGPL-3.0<br>⭐ Star: 1K | Google Analytics, Cloudflare Analytics, Mixpanel | Coming soon | Coming soon |
| [Vemetric](https://open.aiflowlearn.net/vemetric) - Privacy-focused analytics platform combining web and product insights. | license: AGPL-3.0<br>⭐ Star: 352 | Google Analytics, Cloudflare Analytics, Mixpanel | Coming soon | Coming soon |
| [Lua.sh](https://open.aiflowlearn.net/lua-sh) - Open-source platform for creating shortened URLs with advanced analytics, custom domains, and API... | license: AGPL-3.0<br>⭐ Star: 333 | TinyURL, Bitly, Short.io | Coming soon | Coming soon |
| [Betterlytics](https://open.aiflowlearn.net/betterlytics) - GDPR-compliant web analytics with real-time insights, session replay, and funnel tracking. | license: AGPL-3.0<br>⭐ Star: 162 | Google Analytics, Cloudflare Analytics, Mixpanel | Coming soon | Coming soon |
| [Prisme Analytics](https://open.aiflowlearn.net/prisme-analytics) - Prisme offers customizable, GDPR-compliant web analytics with real-time insights, unlimited data... | license: AGPL-3.0<br>⭐ Star: 125 | Google Analytics, Cloudflare Analytics, Mixpanel | Coming soon | Coming soon |
| [HitKeep](https://open.aiflowlearn.net/hitkeep) - Self-hosted or managed web analytics with zero external dependencies. | license: MIT<br>⭐ Star: 59 | Google Analytics, Cloudflare Analytics, Mixpanel | Coming soon | Coming soon |
...
| [Redash](https://open.aiflowlearn.net/redash) - Redash is an open-source data visualization and analytics platform that helps teams make sense of their... | license: BSD-2-Clause<br>⭐ Star: 29K | Power BI, Splunk, Tableau | Coming soon | Coming soon |
...
| [Evidence](https://open.aiflowlearn.net/evidence) - Create data-driven websites and reports using SQL and Markdown, with automatic visualizations and... | license: MIT<br>⭐ Star: 6.4K | Power BI, Tableau, Retool | Coming soon | Coming soon |
...
| [Chartbrew](https://open.aiflowlearn.net/chartbrew) - A powerful, open-source platform for building interactive dashboards and charts from multiple data sources... | license: MIT<br>⭐ Star: 3.9K | Power BI, Tableau, Databox | Coming soon | Coming soon |
| [Deepnote](https://open.aiflowlearn.net/deepnote) - Deepnote is an open-source collaborative notebook for data analysts and scientists, combining Python, SQL,... | license: Apache-2.0<br>⭐ Star: 2.9K | Snowflake, Tableau, Hex | Coming soon | Coming soon |
...
| [DataLens](https://open.aiflowlearn.net/datalens) - Modern analytics system featuring user-friendly interface, native integrations, and unlimited scalability. | license: Apache-2.0<br>⭐ Star: 1.7K | Power BI, Snowflake, Tableau | Coming soon | Coming soon |
| [Frappe Insights](https://open.aiflowlearn.net/frappe-insights) - Connect multiple data sources, build complex queries, create insightful visualizations, and organize... | license: AGPL-3.0<br>⭐ Star: 951 | Power BI, Tableau, Databox | Coming soon | Coming soon |
...
| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Firecrawl](https://open.aiflowlearn.net/firecrawl) - API for AI agents to search, scrape, crawl, and interact with the live web, returning clean Markdown,... | license: AGPL-3.0<br>⭐ Star: 132K | Browserbase, Apify, Jina AI | Coming soon | Coming soon |
| [Crawl4AI](https://open.aiflowlearn.net/crawl4ai) - Open-source web crawler and scraper that produces clean, structured output optimized for LLMs, RAG... | license: Apache-2.0<br>⭐ Star: 68K | Browserbase, Apify, Jina AI | Coming soon | Coming soon |
| [Lightpanda](https://open.aiflowlearn.net/lightpanda) - Purpose-built headless browser that delivers 10x faster performance and 10x lower memory usage compared to... | license: AGPL-3.0<br>⭐ Star: 31K | Browserbase, Anchor Browser | Coming soon | Coming soon |
...
| [Vvveb CMS](https://open.aiflowlearn.net/vvveb-cms) - Vvveb is a feature-rich open source CMS for building websites, blogs, and ecommerce stores with an... | license: AGPL-3.0<br>⭐ Star: 1.1K | WordPress, Webflow, Elementor | Coming soon | Coming soon |
| [Linky](https://open.aiflowlearn.net/linky) - Build a dynamic link-in-bio page with a drag-and-drop editor. | license: MIT<br>⭐ Star: 791 | LinkTree, Bento.me, Bio.fm | Coming soon | Coming soon |
| [Nordcraft](https://open.aiflowlearn.net/nordcraft) - Visual web development engine combining design and development tools. | license: Apache-2.0<br>⭐ Star: 477 | Framer, Webflow, Elementor | Coming soon | Coming soon |
| [Ycode](https://open.aiflowlearn.net/ycode) - Build, manage, and host custom websites with a visual drag-and-drop builder and CMS. | license: MIT<br>⭐ Star: 190 | Framer, Webflow, Wix | Coming soon | Coming soon |

### IDEs & Code Editors

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Zed](https://open.aiflowlearn.net/zed) - A Rust-built code editor from the creators of Atom and Tree-sitter, combining native performance with... | license: Unknown<br>⭐ Star: 85K | Claude Code, Cursor, Kiro | Coming soon | Coming soon |
| [CodeEdit](https://open.aiflowlearn.net/codeedit) - A lightweight, natively built editor. | license: MIT<br>⭐ Star: 23K | Cursor, Kiro, Windsurf | Coming soon | Coming soon |
...
| [PearAI](https://open.aiflowlearn.net/pearai) - PearAI integrates cutting-edge AI tools into a powerful code editor, accelerating your coding process with... | license: Unknown<br>⭐ Star: 749 | Claude Code, Cursor, Kiro | Coming soon | Coming soon |
...
| [Appwrite](https://open.aiflowlearn.net/appwrite) - Open-source development platform with built-in backend infrastructure, web hosting, and security features. | license: BSD-3-Clause<br>⭐ Star: 56K | Supabase, Vercel, Netlify | Coming soon | Coming soon |
| [AppSmith](https://open.aiflowlearn.net/appsmith) - Low-code platform for creating powerful internal tools and dashboards with drag-and-drop ease, robust... | license: Apache-2.0<br>⭐ Star: 40K | Make, Retool, Power Apps | Coming soon | Coming soon |
| [ToolJet](https://open.aiflowlearn.net/tooljet) - Open-source low-code platform for creating custom internal tools, dashboards, and admin panels with a... | license: AGPL-3.0<br>⭐ Star: 38K | Retool, Airplane, OutSystems | Coming soon | Coming soon |
| [TipTap](https://open.aiflowlearn.net/tiptap) - A customizable, open-source rich text editor framework for modern web applications, built on Vue and... | license: MIT<br>⭐ Star: 37K | - | Coming soon | Coming soon |
| [Directus](https://open.aiflowlearn.net/directus) - A versatile headless CMS and API engine that simplifies data management, content creation, and application... | license: Unknown<br>⭐ Star: 36K | WordPress, Sanity, Contentful | Coming soon | Coming soon |
| [Refine](https://open.aiflowlearn.net/refine) - A React-based framework for rapid development of internal tools, admin panels, and dashboards with... | license: MIT<br>⭐ Star: 35K | Retool, Airplane, OutSystems | Coming soon | Coming soon |
| [Budibase](https://open.aiflowlearn.net/budibase) - Low-code platform for creating custom business applications quickly. | license: Unknown<br>⭐ Star: 28K | Glide, Retool, Power Apps | Coming soon | Coming soon |
...
| [Onlook](https://open.aiflowlearn.net/onlook) - Onlook is an open-source desktop app that allows you to visually edit React applications and automatically... | license: Apache-2.0<br>⭐ Star: 26K | Framer, Webflow, Wix | Coming soon | Coming soon |
...
| [NocoBase](https://open.aiflowlearn.net/nocobase) - Open-source no-code platform for creating tailored business applications quickly, with full customization... | license: Unknown<br>⭐ Star: 23K | Airtable, Retool, Power Apps | Coming soon | Coming soon |
...
| [AITable](https://open.aiflowlearn.net/apitable) - AITable.ai offers a visual database platform that simplifies workflow automation and connects to over... | license: AGPL-3.0<br>⭐ Star: 15K | Airtable, Glide, Coda | Coming soon | Coming soon |
...
| [Convex](https://open.aiflowlearn.net/convex) - Open-source reactive database that keeps your web and mobile apps in sync. | license: Unknown<br>⭐ Star: 12K | Supabase, Firebase, Fauna | Coming soon | Coming soon |
...
| [Chartbrew](https://open.aiflowlearn.net/chartbrew) - A powerful, open-source platform for building interactive dashboards and charts from multiple data sources... | license: MIT<br>⭐ Star: 3.9K | Power BI, Tableau, Databox | Coming soon | Coming soon |
| [Bknd](https://open.aiflowlearn.net/bknd) - Lightweight Firebase alternative with database, auth, storage, and workflows. | license: Apache-2.0<br>⭐ Star: 3.7K | Supabase, Firebase, AppWrite | Coming soon | Coming soon |
| [OpnForm](https://open.aiflowlearn.net/opnform) - A versatile open-source form builder for collecting data, managing submissions, and integrating with your... | license: AGPL-3.0<br>⭐ Star: 3.5K | Google Forms, Tally, Typeform | Coming soon | Coming soon |
...
| [Silex](https://open.aiflowlearn.net/silex) - An online tool for visually creating static sites with dynamic data. | license: AGPL-3.0<br>⭐ Star: 2.8K | Framer, Webflow, Wix | Coming soon | Coming soon |
| [Grida](https://open.aiflowlearn.net/grida) - Design and build web applications on an open canvas with AI-powered tools, Figma integration, pixel... | license: Apache-2.0<br>⭐ Star: 2.5K | Figma, Paper, Framer | Coming soon | Coming soon |
| [Frappe Builder](https://open.aiflowlearn.net/frappe-builder) - Frappe Builder is an open-source, low-code website builder that enables users to create beautiful,... | license: AGPL-3.0<br>⭐ Star: 2K | WordPress, Framer, Webflow | Coming soon | Coming soon |
| [Tailcall](https://open.aiflowlearn.net/tailcall) - Swiftly design and ship best-practice GraphQL backends atop existing data sources and APIs. | license: Apache-2.0<br>⭐ Star: 1.4K | Hasura, Apollo GraphQL | Coming soon | Coming soon |
| [WunderGraph](https://open.aiflowlearn.net/wundergraph) - A powerful backend framework that simplifies API integration, enhances security, and boosts developer... | license: Apache-2.0<br>⭐ Star: 1.2K | Hasura, Apollo GraphQL, Stepzen | Coming soon | Coming soon |
| [ProcessWire](https://open.aiflowlearn.net/processwire) - A versatile, open-source content management system with a powerful API, modular architecture, and... | license: Unknown<br>⭐ Star: 1.1K | WordPress, Sanity | Coming soon | Coming soon |
| [Vvveb CMS](https://open.aiflowlearn.net/vvveb-cms) - Vvveb is a feature-rich open source CMS for building websites, blogs, and ecommerce stores with an... | license: AGPL-3.0<br>⭐ Star: 1.1K | WordPress, Webflow, Elementor | Coming soon | Coming soon |
| [Hercules](https://open.aiflowlearn.net/hercules) - Hercules is an AI-powered testing agent that enables zero-code, zero-maintenance automated testing for web... | license: AGPL-3.0<br>⭐ Star: 1K | - | Coming soon | Coming soon |
...
| [Structr](https://open.aiflowlearn.net/structr) - Open-source low-code platform combining Neo4j graph database, visual schema editor, automatic REST APIs,... | license: Unknown<br>⭐ Star: 825 | - | Coming soon | Coming soon |
| [LyteNyte Grid](https://open.aiflowlearn.net/lytenyte-grid) - High-performance React data table with server-side loading, tree data, pivoting, and advanced features. | license: Unknown<br>⭐ Star: 755 | - | Coming soon | Coming soon |
| [Giselle](https://open.aiflowlearn.net/giselle) - Create powerful AI agents using an intuitive node-based interface that connects multiple LLMs and data... | license: Apache-2.0<br>⭐ Star: 534 | - | Coming soon | Coming soon |
| [Nordcraft](https://open.aiflowlearn.net/nordcraft) - Visual web development engine combining design and development tools. | license: Apache-2.0<br>⭐ Star: 477 | Framer, Webflow, Elementor | Coming soon | Coming soon |
| [Juno](https://open.aiflowlearn.net/juno) - Open-source serverless platform for developers to build, test, and deploy modern apps with authentication,... | license: MIT<br>⭐ Star: 411 | Supabase, Vercel, Netlify | Coming soon | Coming soon |
| [Capgo](https://open.aiflowlearn.net/capgo) - Over-the-air update solution for Capacitor apps that enables instant deployment of bug fixes and features... | license: AGPL-3.0<br>⭐ Star: 198 | - | Coming soon | Coming soon |
| [Palform](https://open.aiflowlearn.net/palform) - Build end-to-end encrypted forms with enterprise-grade features, no coding required. | license: AGPL-3.0<br>⭐ Star: 44 | Google Forms, Typeform, Jotform | Coming soon | Coming soon |
| [CodeZero](https://open.aiflowlearn.net/codezero) - Open-source no-code automation platform for logistics, chatbots, and AI agents. | license: Unknown<br>⭐ Star: 35 | Zoho Flow, Azure Logic Apps | Coming soon | Coming soon |
| [Proxed AI](https://open.aiflowlearn.net/proxed-ai) - A secure proxy service that protects AI API keys using Apple DeviceCheck, enabling safe integration of... | license: AGPL-3.0<br>⭐ Star: 7 | - | Coming soon | Coming soon |
...
| [Tailcall](https://open.aiflowlearn.net/tailcall) - Swiftly design and ship best-practice GraphQL backends atop existing data sources and APIs. | license: Apache-2.0<br>⭐ Star: 1.4K | Hasura, Apollo GraphQL | Coming soon | Coming soon |
| [Voiden](https://open.aiflowlearn.net/voiden) - Offline-first API workspace that unifies specs, docs, tests, and mocks in programmable Markdown blocks. | license: Apache-2.0<br>⭐ Star: 1.2K | Postman, Testfully | Coming soon | Coming soon |
| [WunderGraph](https://open.aiflowlearn.net/wundergraph) - A powerful backend framework that simplifies API integration, enhances security, and boosts developer... | license: Apache-2.0<br>⭐ Star: 1.2K | Hasura, Apollo GraphQL, Stepzen | Coming soon | Coming soon |
| [Hive](https://open.aiflowlearn.net/hive) - A fully open-source schema registry, analytics, and gateway for GraphQL federation and APIs | license: MIT<br>⭐ Star: 481 | Hasura, Apollo GraphQL, Stepzen | Coming soon | Coming soon |
| [Gravitee](https://open.aiflowlearn.net/gravitee) - Full-lifecycle API management platform that unifies synchronous and asynchronous ecosystems. | license: Apache-2.0<br>⭐ Star: 421 | Postman, Kong, Amazon API Gateway | Coming soon | Coming soon |
...
| [Quant-UX](https://open.aiflowlearn.net/quant-ux) - Quant-UX is an open-source tool for creating interactive prototypes, conducting user tests, and analyzing... | license: GPL-3.0<br>⭐ Star: 2.6K | Figma, Miro, Paper | Coming soon | Coming soon |
| [Hercules](https://open.aiflowlearn.net/hercules) - Hercules is an AI-powered testing agent that enables zero-code, zero-maintenance automated testing for web... | license: AGPL-3.0<br>⭐ Star: 1K | - | Coming soon | Coming soon |
| [Argos](https://open.aiflowlearn.net/argos) - Automate visual testing, catch UI bugs early, and collaborate effortlessly with your team to maintain... | license: MIT<br>⭐ Star: 589 | Applitools, Chromatic, Percy | Coming soon | Coming soon |
...
| [Reflex](https://open.aiflowlearn.net/reflex) - Build, iterate, and deploy full-stack web apps entirely in Python. | license: Apache-2.0<br>⭐ Star: 28K | Lovable, Base44, Replit | Coming soon | Coming soon |
| [GitLab](https://open.aiflowlearn.net/gitlab) - A comprehensive AI-powered DevSecOps platform that integrates development, security, and operations,... | license: Unknown<br>⭐ Star: 24K | GitHub, GitHub Actions, BitBucket | Coming soon | Coming soon |
| [GitButler](https://open.aiflowlearn.net/gitbutler) - GitButler is a powerful Git client that enables seamless work on multiple branches concurrently, enhancing... | license: Unknown<br>⭐ Star: 21K | - | Coming soon | Coming soon |
| [Gitpod](https://open.aiflowlearn.net/gitpod) - Standardized, automated dev environments in the cloud. | license: AGPL-3.0<br>⭐ Star: 14K | Microsoft Dev Box, GitHub Codespaces, BitBucket | Coming soon | Coming soon |
| [Coder](https://open.aiflowlearn.net/coder) - Self-hosted development platform that enables secure, scalable remote coding with automated provisioning,... | license: AGPL-3.0<br>⭐ Star: 13K | Microsoft Dev Box, GitHub Codespaces, Amazon CodeCatalyst | Coming soon | Coming soon |
| [Encore](https://open.aiflowlearn.net/encore) - A powerful platform for building cloud backends, automating infrastructure, and simplifying development... | license: MPL-2.0<br>⭐ Star: 12K | Supabase, Firebase, AppWrite | Coming soon | Coming soon |
| [Forgejo](https://open.aiflowlearn.net/forgejo) - Self-hosted software forge offering GitHub-like features with minimal resources. | license: Unknown<br>⭐ Star: 4.9K | GitHub, BitBucket | Coming soon | Coming soon |
| [Shelve](https://open.aiflowlearn.net/shelve) - Shelve is a comprehensive project management tool designed to streamline workflows and enhance... | license: Apache-2.0<br>⭐ Star: 425 | Doppler, Keeper | Coming soon | Coming soon |
| [CodinIT.dev](https://open.aiflowlearn.net/codinit-dev) - Build, deploy, and own full-stack web apps using AI prompts. | license: Apache-2.0<br>⭐ Star: 171 | Lovable, Base44, Replit | Coming soon | Coming soon |

### Code Analysis & Transformation

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Grit](https://open.aiflowlearn.net/grit) - Grit uses machine learning and static analysis to automatically generate pull requests that clean up code... | license: MIT<br>⭐ Star: 4.5K | - | Coming soon | Coming soon |
...
| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Coolify](https://open.aiflowlearn.net/coolify) - Self-hostable deployment platform that lets you deploy apps, databases, and 280+ one-click services to any... | license: Apache-2.0<br>⭐ Star: 57K | Vercel, Netlify, Heroku | Coming soon | Coming soon |
| [Appwrite](https://open.aiflowlearn.net/appwrite) - Open-source development platform with built-in backend infrastructure, web hosting, and security features. | license: BSD-3-Clause<br>⭐ Star: 56K | Supabase, Vercel, Netlify | Coming soon | Coming soon |
| [Harness](https://open.aiflowlearn.net/harness) - Streamline code delivery with an open-source CI/CD platform featuring Git integration, fast pipelines, and... | license: Apache-2.0<br>⭐ Star: 37K | GitHub, Red Hat Ansible, GitHub Actions | Coming soon | Coming soon |
| [Dokploy](https://open.aiflowlearn.net/dokploy) - Streamline your deployment process with Dokploy. | license: Unknown<br>⭐ Star: 35K | Vercel, Netlify, Heroku | Coming soon | Coming soon |
| [Dokku](https://open.aiflowlearn.net/dokku) - A Docker-powered platform that lets you deploy Heroku-compatible applications via Git, with buildpack... | license: MIT<br>⭐ Star: 32K | Vercel, Netlify, Heroku | Coming soon | Coming soon |
| [GitLab](https://open.aiflowlearn.net/gitlab) - A comprehensive AI-powered DevSecOps platform that integrates development, security, and operations,... | license: Unknown<br>⭐ Star: 24K | GitHub, GitHub Actions, BitBucket | Coming soon | Coming soon |
| [NocoBase](https://open.aiflowlearn.net/nocobase) - Open-source no-code platform for creating tailored business applications quickly, with full customization... | license: Unknown<br>⭐ Star: 23K | Airtable, Retool, Power Apps | Coming soon | Coming soon |
...
| [Nitric](https://open.aiflowlearn.net/nitric) - Nitric automates cloud infrastructure provisioning from your application code for AWS, GCP and Azure | license: Apache-2.0<br>⭐ Star: 2K | Supabase, Firebase, Hasura | Coming soon | Coming soon |
| [Dyrector](https://open.aiflowlearn.net/dyrector) - Effortless container orchestration platform for seamless deployment, management, and monitoring of... | license: Apache-2.0<br>⭐ Star: 1.8K | - | Coming soon | Coming soon |
| [FeatBit](https://open.aiflowlearn.net/featbit) - FeatBit is a fast, scalable feature flag service that enables risk mitigation and fosters business growth... | license: MIT<br>⭐ Star: 1.8K | LaunchDarkly, Hypertune, Statsig | Coming soon | Coming soon |
| [Semaphore](https://open.aiflowlearn.net/semaphore) - Continuous integration and delivery platform offering faster builds, lower costs, and maintenance-free... | license: Unknown<br>⭐ Star: 1.5K | GitHub Actions, Jenkins, CircleCI | Coming soon | Coming soon |
| [Terrateam](https://open.aiflowlearn.net/terrateam) - Automate infrastructure changes with secure GitOps workflows. | license: MPL-2.0<br>⭐ Star: 1.2K | Red Hat Ansible, Terraform, Puppet | Coming soon | Coming soon |
...
| [Stormkit](https://open.aiflowlearn.net/stormkit) - Self-hosted platform for web applications offering automated CI/CD pipelines, multiple environments, and... | license: GPL-3.0<br>⭐ Star: 226 | Vercel, Netlify, Heroku | Coming soon | Coming soon |
| [Capgo](https://open.aiflowlearn.net/capgo) - Over-the-air update solution for Capacitor apps that enables instant deployment of bug fixes and features... | license: AGPL-3.0<br>⭐ Star: 198 | - | Coming soon | Coming soon |
...
| [TechBlitz](https://open.aiflowlearn.net/techblitz) - Learn to code through interactive challenges, personalized learning paths, and AI-powered assistance | license: Apache-2.0<br>⭐ Star: 432 | Udemy, Coursera, LeetCode | Coming soon | Coming soon |
| [CodinIT.dev](https://open.aiflowlearn.net/codinit-dev) - Build, deploy, and own full-stack web apps using AI prompts. | license: Apache-2.0<br>⭐ Star: 171 | Lovable, Base44, Replit | Coming soon | Coming soon |
| [Cody](https://open.aiflowlearn.net/cody) - Advanced AI coding assistant that helps enterprise teams write, fix, and maintain code with enhanced... | license: Apache-2.0<br>⭐ Star: 86 | Claude Code, Cursor, Kiro | Coming soon | Coming soon |
| [OmoiOS](https://open.aiflowlearn.net/omoios) - Deploy AI agents that build features, fix bugs, and handle complex workflows overnight. | license: Apache-2.0<br>⭐ Star: 64 | Cursor, Kiro, Devin | Coming soon | Coming soon |
...
| [Quickwit](https://open.aiflowlearn.net/quickwit) - High-performance search engine designed for big data, offering scalability, real-time indexing, and... | license: Apache-2.0<br>⭐ Star: 11K | Algolia, ElasticSearch, Coveo | Coming soon | Coming soon |
| [Swirl Search](https://open.aiflowlearn.net/swirl) - AI-powered search and RAG platform that connects to 100+ enterprise tools without data migration. | license: Apache-2.0<br>⭐ Star: 3K | Algolia, ElasticSearch, AWS Kendra | Coming soon | Coming soon |
...
| --- | --- | --- | --- | --- |
| [Coolify](https://open.aiflowlearn.net/coolify) - Self-hostable deployment platform that lets you deploy apps, databases, and 280+ one-click services to any... | license: Apache-2.0<br>⭐ Star: 57K | Vercel, Netlify, Heroku | Coming soon | Coming soon |
| [OpenTofu](https://open.aiflowlearn.net/opentofu) - A community-driven, truly open-source fork of Terraform for managing cloud infrastructure through code. | license: MPL-2.0<br>⭐ Star: 29K | Red Hat Ansible, Terraform, Puppet | Coming soon | Coming soon |
| [Pulumi](https://open.aiflowlearn.net/pulumi) - Pulumi enables developers to define and manage cloud infrastructure using familiar programming languages... | license: Apache-2.0<br>⭐ Star: 25K | Red Hat Ansible, Terraform, Puppet | Coming soon | Coming soon |
| [AutoMQ](https://open.aiflowlearn.net/automq) - AutoMQ is a serverless Kafka alternative built on S3 that offers 10x cost savings, easy scalability, and... | license: Apache-2.0<br>⭐ Star: 10K | - | Coming soon | Coming soon |
| [OpenStack](https://open.aiflowlearn.net/openstack) - OpenStack manages compute, storage, and networking across VMs, bare metal, and containers via APIs or a... | license: Apache-2.0<br>⭐ Star: 5.9K | Microsoft Azure, Google Cloud | Coming soon | Coming soon |
| [Digger](https://open.aiflowlearn.net/digger) - Open-source CI/CD orchestrator for Terraform with pull request automation, drift detection, and... | license: MIT<br>⭐ Star: 5K | Red Hat Ansible, Terraform, Puppet | Coming soon | Coming soon |
| [Flexprice](https://open.aiflowlearn.net/flexprice) - A flexible billing platform that handles usage-based metering, credit management, and subscription... | license: AGPL-3.0<br>⭐ Star: 3.6K | Stripe Billing, Orb | Coming soon | Coming soon |
| [Cozystack](https://open.aiflowlearn.net/cozystack) - Transform bare metal servers into a complete cloud platform with REST API for Kubernetes clusters,... | license: Apache-2.0<br>⭐ Star: 2.1K | Microsoft Azure, VMware, Google Cloud | Coming soon | Coming soon |
| [Nitric](https://open.aiflowlearn.net/nitric) - Nitric automates cloud infrastructure provisioning from your application code for AWS, GCP and Azure | license: Apache-2.0<br>⭐ Star: 2K | Supabase, Firebase, Hasura | Coming soon | Coming soon |
| [OpenMeter](https://open.aiflowlearn.net/openmeter) - Open source billing platform that turns events into revenue with real-time metering, usage limits, and... | license: Apache-2.0<br>⭐ Star: 2K | Stripe Billing, Recurly, Zuora | Coming soon | Coming soon |
| [Terrateam](https://open.aiflowlearn.net/terrateam) - Automate infrastructure changes with secure GitOps workflows. | license: MPL-2.0<br>⭐ Star: 1.2K | Red Hat Ansible, Terraform, Puppet | Coming soon | Coming soon |
...
| [Dokploy](https://open.aiflowlearn.net/dokploy) - Streamline your deployment process with Dokploy. | license: Unknown<br>⭐ Star: 35K | Vercel, Netlify, Heroku | Coming soon | Coming soon |
| [Refine](https://open.aiflowlearn.net/refine) - A React-based framework for rapid development of internal tools, admin panels, and dashboards with... | license: MIT<br>⭐ Star: 35K | Retool, Airplane, OutSystems | Coming soon | Coming soon |
| [CasaOS](https://open.aiflowlearn.net/casaos) - CasaOS is an open-source personal cloud system that makes it easy to set up and manage your own home server | license: Apache-2.0<br>⭐ Star: 34K | Umbrel, HomeKit | Coming soon | Coming soon |
| [Cosmos Server](https://open.aiflowlearn.net/cosmos-server) - Complete self-hosting solution with automated maintenance, Smart-Shield protection, anti-DDoS, SSO... | license: Unknown<br>⭐ Star: 6K | - | Coming soon | Coming soon |
| [aaPanel](https://open.aiflowlearn.net/aapanel) - aaPanel simplifies Linux server management with one-click installations, intuitive interface, and... | license: Unknown<br>⭐ Star: 3K | cPanel, Plesk | Coming soon | Coming soon |
| [YunoHost](https://open.aiflowlearn.net/yunohost) - Install and maintain your own server with minimal technical knowledge. | license: AGPL-3.0<br>⭐ Star: 2.9K | Umbrel, HomeKit | Coming soon | Coming soon |
| [OpenPanel](https://open.aiflowlearn.net/openpanel-co) - A user-friendly, open-source control panel for effortless server administration, designed for both... | license: MIT<br>⭐ Star: 685 | cPanel, Plesk | Coming soon | Coming soon |
| [Temps](https://open.aiflowlearn.net/temps) - Self-hosted platform for small dev teams combining deployments, error tracking, analytics, session replay,... | license: Apache-2.0<br>⭐ Star: 476 | Vercel, Netlify, Heroku | Coming soon | Coming soon |
...
| [AITable](https://open.aiflowlearn.net/apitable) - AITable.ai offers a visual database platform that simplifies workflow automation and connects to over... | license: AGPL-3.0<br>⭐ Star: 15K | Airtable, Glide, Coda | Coming soon | Coming soon |
| [Bytebase](https://open.aiflowlearn.net/bytebase) - Comprehensive platform for database schema migrations, security controls, and data masking with built-in... | license: Unknown<br>⭐ Star: 14K | - | Coming soon | Coming soon |
| [FerretDB](https://open.aiflowlearn.net/ferretdb) - A database proxy that enables MongoDB compatibility with PostgreSQL backend, allowing seamless use of... | license: Apache-2.0<br>⭐ Star: 11K | Fauna, AWS Aurora, MongoDB | Coming soon | Coming soon |
| [Grist](https://open.aiflowlearn.net/grist) - A versatile data management platform combining spreadsheet simplicity with relational database... | license: Apache-2.0<br>⭐ Star: 11K | Airtable, Microsoft Excel, Google Sheets | Coming soon | Coming soon |
| [Instant](https://open.aiflowlearn.net/instant) - Instant is a database solution for building real-time and offline-enabled applications, simplifying the... | license: Apache-2.0<br>⭐ Star: 10K | Supabase, Firebase, Fauna | Coming soon | Coming soon |
...
| [Memgraph](https://open.aiflowlearn.net/memgraph) - Memgraph is a scalable, in-memory graph database solution offering high-performance computing and Neo4j... | license: Unknown<br>⭐ Star: 4.2K | Amazon Neptune, MongoDB, TigerGraph | Coming soon | Coming soon |
| [CozoDB](https://open.aiflowlearn.net/cozodb) - A transactional, relational-graph-vector database that uses Datalog for query. | license: MPL-2.0<br>⭐ Star: 4K | Pinecone, Weaviate | Coming soon | Coming soon |
| [Garage](https://open.aiflowlearn.net/garage) - Self-contained distributed object storage with S3 API compatibility. | license: AGPL-3.0<br>⭐ Star: 4K | Amazon S3, Azure Blob Storage, Google Cloud Storage | Coming soon | Coming soon |
| [Storj](https://open.aiflowlearn.net/storj) - Storj offers a distributed cloud storage platform with enhanced security, global performance, and... | license: AGPL-3.0<br>⭐ Star: 3.3K | Amazon S3, Azure Blob Storage, Google Cloud Storage | Coming soon | Coming soon |
| [SlateDB](https://open.aiflowlearn.net/slatedb) - SlateDB is an embedded storage engine that leverages object storage for durability, scalability, and... | license: Apache-2.0<br>⭐ Star: 3.1K | Supabase, Amazon S3, Azure Blob Storage | Coming soon | Coming soon |
| [Hydra](https://open.aiflowlearn.net/hydra) - Hydra embeds DuckDB's state-of-the-art analytics engine into standard Postgres, offering millisecond... | license: Apache-2.0<br>⭐ Star: 3K | Supabase, Firebase, Snowflake | Coming soon | Coming soon |
| [undb](https://open.aiflowlearn.net/undb) - Build and manage custom databases with ease, create type-safe APIs, and develop applications quickly | license: AGPL-3.0<br>⭐ Star: 2.9K | Supabase, Airtable, Firebase | Coming soon | Coming soon |
...
| [Temporal](https://open.aiflowlearn.net/temporal) - Open source platform that eliminates infrastructure complexity by handling failures, network issues, and... | license: MIT<br>⭐ Star: 21K | - | Coming soon | Coming soon |
| [Windmill](https://open.aiflowlearn.net/windmill) - Powerful, self-hosted platform for building and running workflows, scripts, and apps with code-first... | license: Unknown<br>⭐ Star: 17K | Make, Zapier, IFTTT | Coming soon | Coming soon |
| [Trigger](https://open.aiflowlearn.net/trigger) - Open source TypeScript platform for building and deploying AI agents and background workflows with... | license: Apache-2.0<br>⭐ Star: 15K | Make, Zapier, Pipedream | Coming soon | Coming soon |
| [Automatisch](https://open.aiflowlearn.net/automatisch) - Self-hosted automation tool that connects your apps and services, enabling powerful integrations and... | license: Unknown<br>⭐ Star: 14K | n8n, Make, Zapier | Coming soon | Coming soon |
| [Mage](https://open.aiflowlearn.net/mage) - Open-source data pipeline platform for effortless data integration, transformation, and orchestration... | license: Apache-2.0<br>⭐ Star: 8.8K | Pipedream, Supermetrics, Amazon API Gateway | Coming soon | Coming soon |
...
| [dstack](https://open.aiflowlearn.net/dstack) - Open-source container orchestrator designed for AI teams. | license: MPL-2.0<br>⭐ Star: 2.2K | Docker Swarm, Kubernetes | Coming soon | Coming soon |
| [Dyrector](https://open.aiflowlearn.net/dyrector) - Effortless container orchestration platform for seamless deployment, management, and monitoring of... | license: Apache-2.0<br>⭐ Star: 1.8K | - | Coming soon | Coming soon |
| [Terrateam](https://open.aiflowlearn.net/terrateam) - Automate infrastructure changes with secure GitOps workflows. | license: MPL-2.0<br>⭐ Star: 1.2K | Red Hat Ansible, Terraform, Puppet | Coming soon | Coming soon |
| [Bacalhau](https://open.aiflowlearn.net/bacalhau) - Bacalhau is an open-source platform for fast, cost-effective, and secure distributed computing, seamlessly... | license: Apache-2.0<br>⭐ Star: 862 | - | Coming soon | Coming soon |
| [Giselle](https://open.aiflowlearn.net/giselle) - Create powerful AI agents using an intuitive node-based interface that connects multiple LLMs and data... | license: Apache-2.0<br>⭐ Star: 534 | - | Coming soon | Coming soon |
...
| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Ntfy](https://open.aiflowlearn.net/ntfy) - A lightweight, open-source solution for sending real-time notifications to your devices, with end-to-end... | license: Apache-2.0<br>⭐ Star: 31K | - | Coming soon | Coming soon |
| [AutoMQ](https://open.aiflowlearn.net/automq) - AutoMQ is a serverless Kafka alternative built on S3 that offers 10x cost savings, easy scalability, and... | license: Apache-2.0<br>⭐ Star: 10K | - | Coming soon | Coming soon |
| [Soketi](https://open.aiflowlearn.net/soketi) - Open-source, Pusher-compatible WebSockets server that's simple, fast, and resilient for building real-time... | license: AGPL-3.0<br>⭐ Star: 5.6K | - | Coming soon | Coming soon |
| [Timeplus](https://open.aiflowlearn.net/timeplus) - Timeplus is a lightweight, powerful, and cost-efficient stream processing platform for real-time... | license: Apache-2.0<br>⭐ Star: 2.2K | - | Coming soon | Coming soon |
| [Sequin](https://open.aiflowlearn.net/sequin) - Sequin offers a feature-rich messaging system with a simple HTTP API, providing RabbitMQ-like... | license: MIT<br>⭐ Star: 2.1K | - | Coming soon | Coming soon |
| [Trench](https://open.aiflowlearn.net/trench) - Open source analytics platform built on ClickHouse and Kafka, offering high-speed event tracking and... | license: MIT<br>⭐ Star: 1.6K | Mixpanel, Amplitude, June | Coming soon | Coming soon |
| [Hook0](https://open.aiflowlearn.net/hook0) - Self-hosted webhook solution for effortless event-driven communication between applications, enhancing... | license: Unknown<br>⭐ Star: 1.4K | Zapier, IFTTT, Pipedream | Coming soon | Coming soon |
| [Operational](https://open.aiflowlearn.net/operational) - Track critical events, receive instant notifications, and respond to product activities with customizable... | license: AGPL-3.0<br>⭐ Star: 465 | Opsgenie, LogSnag | Coming soon | Coming soon |
...
| [Ente](https://open.aiflowlearn.net/ente) - End-to-end encrypted cloud storage for photos and videos, offering privacy, security, and seamless... | license: AGPL-3.0<br>⭐ Star: 27K | Google Drive, Microsoft OneDrive, Dropbox | Coming soon | Coming soon |
| [Ceph](https://open.aiflowlearn.net/ceph) - Ceph provides unified object, block, and file storage from a single cluster built on commodity hardware. | license: Unknown<br>⭐ Star: 17K | Amazon S3, Azure Blob Storage, Google Cloud Storage | Coming soon | Coming soon |
| [Filestash](https://open.aiflowlearn.net/filestash) - Filestash is an open-source file manager that integrates with multiple storage backends, authentication... | license: AGPL-3.0<br>⭐ Star: 14K | Google Drive, Microsoft OneDrive, Dropbox | Coming soon | Coming soon |
| [Garage](https://open.aiflowlearn.net/garage) - Self-contained distributed object storage with S3 API compatibility. | license: AGPL-3.0<br>⭐ Star: 4K | Amazon S3, Azure Blob Storage, Google Cloud Storage | Coming soon | Coming soon |
| [Storj](https://open.aiflowlearn.net/storj) - Storj offers a distributed cloud storage platform with enhanced security, global performance, and... | license: AGPL-3.0<br>⭐ Star: 3.3K | Amazon S3, Azure Blob Storage, Google Cloud Storage | Coming soon | Coming soon |
| [Cozy](https://open.aiflowlearn.net/cozy) - Open-source personal cloud that automatically gathers all your data from third-party services. | license: AGPL-3.0<br>⭐ Star: 1.3K | 1Password, ownCloud, Keeper | Coming soon | Coming soon |
| [Hoodik](https://open.aiflowlearn.net/hoodik) - Lightweight, self-hosted cloud storage built with Rust and Vue.js. | license: Unknown<br>⭐ Star: 1.3K | Dropbox, WeTransfer, Mega | Coming soon | Coming soon |
| [Twake Drive](https://open.aiflowlearn.net/twake-drive) - Open source encrypted data storage solution offering secure file sharing, collaboration tools, and... | license: AGPL-3.0<br>⭐ Star: 943 | Google Drive, Microsoft OneDrive, Dropbox | Coming soon | Coming soon |
| [Firefiles](https://open.aiflowlearn.net/firefiles) - Firefiles is an open-source alternative to Dropbox that lets you manage files across multiple cloud... | license: AGPL-3.0<br>⭐ Star: 371 | Google Drive, Microsoft OneDrive, Dropbox | Coming soon | Coming soon |
...
| [Hey](https://open.aiflowlearn.net/hey) - A blockchain-powered social platform offering censorship-resistant content sharing, user-owned data, and... | license: GPL-3.0<br>⭐ Star: 29K | X (Twitter), Threads | Coming soon | Coming soon |
| [Hummingbot](https://open.aiflowlearn.net/hummingbot) - Automate crypto trading strategies with a powerful, customizable platform. | license: Apache-2.0<br>⭐ Star: 19K | - | Coming soon | Coming soon |
| [OctoBot](https://open.aiflowlearn.net/octobot) - OctoBot is an open-source platform for automated cryptocurrency trading, offering customizable strategies... | license: GPL-3.0<br>⭐ Star: 6.1K | - | Coming soon | Coming soon |
| [Sigle](https://open.aiflowlearn.net/sigle) - Sigle is a secure, open-source platform for Web3 writers to create, publish, and monetize content on the... | license: MIT<br>⭐ Star: 486 | Substack, Beehiiv, Medium | Coming soon | Coming soon |
| [0 Finance](https://open.aiflowlearn.net/0-finance) - High-yield treasury management for startups earning 8% APY with insurance coverage up to $1M. | license: MIT<br>⭐ Star: 230 | - | Coming soon | Coming soon |
...
| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Godot](https://open.aiflowlearn.net/godot) - Build 2D, 3D, and XR games with a full-featured engine that includes its own scripting language, scene... | license: MIT<br>⭐ Star: 112K | Unreal Engine, Unity | Coming soon | Coming soon |
| [GDevelop](https://open.aiflowlearn.net/gdevelop) - Free, open-source game engine with visual event system, AI tutor, and one-click publishing to Steam, iOS,... | license: Unknown<br>⭐ Star: 24K | Unreal Engine, Unity | Coming soon | Coming soon |
| [s&box](https://open.aiflowlearn.net/sbox) - A game creation platform built on Valve's Source 2 engine, letting you build, share, and play games... | license: Unknown<br>⭐ Star: 6.3K | Unreal Engine, Unity | Coming soon | Coming soon |
...
| [PeerTube](https://open.aiflowlearn.net/peertube) - Create your own video hosting platform with PeerTube - a free, open-source alternative to YouTube. | license: AGPL-3.0<br>⭐ Star: 15K | - | Coming soon | Coming soon |
| [Anthias](https://open.aiflowlearn.net/anthias) - Free open-source digital signage software that turns Raspberry Pi or old PCs into powerful display solutions. | license: Unknown<br>⭐ Star: 3.6K | Screenly, Yodeck, OptiSigns | Coming soon | Coming soon |
| [BookWyrm](https://open.aiflowlearn.net/bookwyrm) - Join a federated social reading platform where you can track books, write reviews, discover... | license: Unknown<br>⭐ Star: 2.7K | Goodreads, Literal | Coming soon | Coming soon |
| [Openinary](https://open.aiflowlearn.net/openinary) - Open-source alternative to Cloudinary offering self-hosted media transformation. | license: AGPL-3.0<br>⭐ Star: 334 | Cloudinary, ImageKit, Acquia DAM | Coming soon | Coming soon |
...
| [Darktable](https://open.aiflowlearn.net/darktable) - Open source photography workflow application for RAW development. | license: GPL-3.0<br>⭐ Star: 13K | Adobe Lightroom, Affinity Photo | Coming soon | Coming soon |
...
| [AppFlowy](https://open.aiflowlearn.net/appflowy) - Open source collaborative workspace combining notes, databases, and AI with full data ownership, offline... | license: AGPL-3.0<br>⭐ Star: 72K | Notion, Obsidian, OneNote | Coming soon | Coming soon |
| [Affine](https://open.aiflowlearn.net/affine) - An open-source, local-first knowledge base that merges structured docs, infinite whiteboards, databases,... | license: Unknown<br>⭐ Star: 69K | Notion, OneNote, Confluence | Coming soon | Coming soon |
| [Memos](https://open.aiflowlearn.net/memos) - Memos is a self-hosted, open-source note-taking app built around a private timeline. | license: MIT<br>⭐ Star: 61K | Notion, Obsidian, OneNote | Coming soon | Coming soon |
| [Joplin](https://open.aiflowlearn.net/joplin) - Cross-platform note-taking app with end-to-end encryption, Markdown support, web clipping, and sync via... | license: Unknown<br>⭐ Star: 55K | Obsidian, OneNote, Google Keep | Coming soon | Coming soon |
...
| [Vrite](https://open.aiflowlearn.net/vrite) - A powerful platform for technical writing, offering real-time collaboration, version control, and seamless... | license: Unknown<br>⭐ Star: 2K | Mintlify, Gitbook | Coming soon | Coming soon |
| [Beaver Notes](https://open.aiflowlearn.net/beaver-notes) - A privacy-focused, offline-first note-taking app that stores everything on your device, with Markdown,... | license: MIT<br>⭐ Star: 1.3K | Notion, Obsidian, OneNote | Coming soon | Coming soon |
| [XWiki](https://open.aiflowlearn.net/xwiki) - XWiki is a flexible, feature-rich wiki software that helps organizations structure and share knowledge... | license: LGPL-2.1<br>⭐ Star: 1.3K | Notion, Obsidian, Confluence | Coming soon | Coming soon |
| [Zen](https://open.aiflowlearn.net/zen) - Minimal note-taking app storing Markdown notes in local SQLite database. | license: AGPL-3.0<br>⭐ Star: 1.1K | OneNote, Google Keep, Apple Notes | Coming soon | Coming soon |
| [Darkwrite](https://open.aiflowlearn.net/darkwrite) - A customizable, offline-first note editor that lets you format text, create lists, add images, and export... | license: AGPL-3.0<br>⭐ Star: 287 | Notion, Obsidian, OneNote | Coming soon | Coming soon |
| [OpenNotas](https://open.aiflowlearn.net/opennotas) - OpenNotas is a multi-platform, end-to-end encrypted note-taking app that offers simplicity,... | license: Unknown<br>⭐ Star: 172 | Obsidian, OneNote, Google Keep | Coming soon | Coming soon |
| [Justnote](https://open.aiflowlearn.net/justnote) - Justnote is a secure note-taking app that lets you easily create and sync notes across devices while... | license: GPL-2.0<br>⭐ Star: 66 | Notion, Obsidian, OneNote | Coming soon | Coming soon |
...
| --- | --- | --- | --- | --- |
| [KeePassXC](https://open.aiflowlearn.net/keepassxc) - KeePassXC is an open-source password manager that securely stores and manages sensitive information across... | license: Unknown<br>⭐ Star: 28K | 1Password, Proton Pass, Keeper | Coming soon | Coming soon |
| [Bitwarden](https://open.aiflowlearn.net/bitwarden) - Bitwarden is an open source password manager that securely stores, shares, and autofills passwords across... | license: Unknown<br>⭐ Star: 19K | 1Password, Doppler, Proton Pass | Coming soon | Coming soon |
| [Passbolt](https://open.aiflowlearn.net/passbolt) - Open source password manager focused on security, collaboration and privacy for organizations | license: AGPL-3.0<br>⭐ Star: 6K | 1Password, Proton Pass, Keeper | Coming soon | Coming soon |
| [Padloc](https://open.aiflowlearn.net/padloc) - Open-source password manager with end-to-end encryption for passwords, credit cards, notes, and documents. | license: AGPL-3.0<br>⭐ Star: 2.9K | 1Password, Proton Pass, Keeper | Coming soon | Coming soon |
| [Keyshade](https://open.aiflowlearn.net/keyshade) - Secure secret management platform with public key encryption, automated rotation, versioning, and... | license: MPL-2.0<br>⭐ Star: 754 | 1Password, Doppler, Keeper | Coming soon | Coming soon |
| [PearPass](https://open.aiflowlearn.net/pearpass) - Open-source password manager with peer-to-peer syncing, local storage, and end-to-end encryption. | license: Apache-2.0<br>⭐ Star: 474 | 1Password, Proton Pass, Keeper | Coming soon | Coming soon |

### Screen Capture & Recording

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [OBS Studio](https://open.aiflowlearn.net/obs-studio) - OBS Studio offers high-quality video recording and live streaming capabilities, supporting multiple... | license: GPL-2.0<br>⭐ Star: 73K | Screen Studio, Loom, CleanShot | Coming soon | Coming soon |
| [ShareX](https://open.aiflowlearn.net/sharex) - ShareX is a free, open-source program that captures or records any area of your screen and shares it with... | license: GPL-3.0<br>⭐ Star: 38K | Screen Studio, Loom, CleanShot | Coming soon | Coming soon |
| [Cap](https://open.aiflowlearn.net/cap) - Record your screen or webcam, edit with backgrounds and effects, then share via link. | license: AGPL-3.0<br>⭐ Star: 20K | Screen Studio, Loom, CleanShot | Coming soon | Coming soon |
| [Kap](https://open.aiflowlearn.net/kap) - Capture, edit, and share your screen with ease. | license: MIT<br>⭐ Star: 19K | Screen Studio, Loom, CleanShot | Coming soon | Coming soon |
...
| [Snapify](https://open.aiflowlearn.net/snapify) - Effortlessly create, share, and collaborate with screen recordings. | license: AGPL-3.0<br>⭐ Star: 1K | Screen Studio, Loom, CleanShot | Coming soon | Coming soon |

### File Management & Sync

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [LocalSend](https://open.aiflowlearn.net/localsend) - Free, open-source file sharing tool for nearby devices. | license: Apache-2.0<br>⭐ Star: 83K | - | Coming soon | Coming soon |
| [Puter](https://open.aiflowlearn.net/puter) - Puter is a cloud-based desktop OS you run in the browser, with built-in apps, file storage, and support... | license: AGPL-3.0<br>⭐ Star: 42K | Google Drive, Microsoft OneDrive, Dropbox | Coming soon | Coming soon |
| [Spacedrive](https://open.aiflowlearn.net/spacedrive) - A cross-platform file manager that unifies your devices into a seamless, organized digital workspace. | license: AGPL-3.0<br>⭐ Star: 38K | Google Drive, Microsoft OneDrive, Dropbox | Coming soon | Coming soon |
| [Nextcloud](https://open.aiflowlearn.net/nextcloud) - Nextcloud offers on-premises file sync, sharing and collaboration platform with advanced security and... | license: AGPL-3.0<br>⭐ Star: 36K | Google Drive, Microsoft Teams, Slack | Coming soon | Coming soon |
| [Seafile](https://open.aiflowlearn.net/seafile) - Open source file sync and sharing platform with custom properties, AI automation, collaborative editing,... | license: Unknown<br>⭐ Star: 15K | Google Drive, Microsoft OneDrive, Dropbox | Coming soon | Coming soon |
| [PairDrop](https://open.aiflowlearn.net/pairdrop) - Share files instantly between devices using peer-to-peer technology. | license: GPL-3.0<br>⭐ Star: 11K | WeTransfer, Apple AirDrop | Coming soon | Coming soon |
| [OpenCloud](https://open.aiflowlearn.net/opencloud) - Self-hostable cloud file management and collaboration platform with an integrated office suite, zero-trust... | license: Apache-2.0<br>⭐ Star: 5.6K | Google Drive, Microsoft OneDrive, Dropbox | Coming soon | Coming soon |
| [Peergos](https://open.aiflowlearn.net/peergos) - A peer-to-peer encrypted filesystem for secure file storage, sharing, and collaboration with end-to-end... | license: AGPL-3.0<br>⭐ Star: 2.4K | Dropbox, Mega, ownCloud | Coming soon | Coming soon |
| [Sync-in](https://open.aiflowlearn.net/sync-in) - Secure, open-source platform for file storage, sharing, and collaboration. | license: AGPL-3.0<br>⭐ Star: 1.4K | Google Drive, Microsoft OneDrive, Dropbox | Coming soon | Coming soon |
| [Cozy](https://open.aiflowlearn.net/cozy) - Open-source personal cloud that automatically gathers all your data from third-party services. | license: AGPL-3.0<br>⭐ Star: 1.3K | 1Password, ownCloud, Keeper | Coming soon | Coming soon |
| [Hoodik](https://open.aiflowlearn.net/hoodik) - Lightweight, self-hosted cloud storage built with Rust and Vue.js. | license: Unknown<br>⭐ Star: 1.3K | Dropbox, WeTransfer, Mega | Coming soon | Coming soon |
...
| [Sendportal](https://open.aiflowlearn.net/sendportal) - Open-source email marketing platform offering unlimited subscribers, campaigns, and workspaces. | license: MIT<br>⭐ Star: 2.1K | Resend, Mailchimp, SendGrid | Coming soon | Coming soon |
| [UnInbox](https://open.aiflowlearn.net/uninbox) - Streamline team communication with shared inboxes, unlimited email addresses, and customizable workflows. | license: Unknown<br>⭐ Star: 1.7K | Microsoft Teams, Gmail, Front | Coming soon | Coming soon |
| [DoubleZero](https://open.aiflowlearn.net/doublezero) - 00 is an open-source email API and infrastructure solution that allows developers to own and control their... | license: AGPL-3.0<br>⭐ Star: 1.2K | Resend, SendGrid, Mailgun | Coming soon | Coming soon |
| [Sessy](https://open.aiflowlearn.net/sessy) - Track SES deliveries, bounces, opens and clicks in a self-hosted dashboard with real-time search,... | license: Unknown<br>⭐ Star: 887 | Resend, SendGrid, Mailgun | Coming soon | Coming soon |
| [Hyvor Relay](https://open.aiflowlearn.net/hyvor-relay) - Self-hosted email API alternative to AWS SES & Mailgun. | license: AGPL-3.0<br>⭐ Star: 627 | Resend, SendGrid, Mailgun | Coming soon | Coming soon |
| [Twake Mail](https://open.aiflowlearn.net/twake-mail) - Open source professional email solution with PGP encryption, JMAP protocol, AI-powered responses, and... | license: AGPL-3.0<br>⭐ Star: 621 | Gmail, Apple Mail | Coming soon | Coming soon |
| [AgentMail](https://open.aiflowlearn.net/agentmail) - Provides AI agents with real email inboxes via REST API. | license: Unknown<br>⭐ Star: 34 | - | Coming soon | Coming soon |
...
| [Leon](https://open.aiflowlearn.net/leon) - Leon is an AI-powered virtual assistant that lives on your server, automating tasks and managing your... | license: MIT<br>⭐ Star: 17K | - | Coming soon | Coming soon |
| [Windmill](https://open.aiflowlearn.net/windmill) - Powerful, self-hosted platform for building and running workflows, scripts, and apps with code-first... | license: Unknown<br>⭐ Star: 17K | Make, Zapier, IFTTT | Coming soon | Coming soon |
| [OpenWork](https://open.aiflowlearn.net/openwork) - Desktop app supporting 50+ LLMs with custom keys, team sharing, and browser automation. | license: MIT<br>⭐ Star: 16K | - | Coming soon | Coming soon |
| [AITable](https://open.aiflowlearn.net/apitable) - AITable.ai offers a visual database platform that simplifies workflow automation and connects to over... | license: AGPL-3.0<br>⭐ Star: 15K | Airtable, Glide, Coda | Coming soon | Coming soon |
| [Botpress](https://open.aiflowlearn.net/botpress) - A comprehensive platform for creating AI agents with intuitive tools, extensive integrations, and... | license: MIT<br>⭐ Star: 15K | Manychat, Voiceflow, Uchat | Coming soon | Coming soon |
| [Automatisch](https://open.aiflowlearn.net/automatisch) - Self-hosted automation tool that connects your apps and services, enabling powerful integrations and... | license: Unknown<br>⭐ Star: 14K | n8n, Make, Zapier | Coming soon | Coming soon |
| [Keep](https://open.aiflowlearn.net/keep) - Open-source platform for centralizing alerts, automating responses, and enhancing incident management... | license: MIT<br>⭐ Star: 12K | Opsgenie, BetterStack, Pagerduty | Coming soon | Coming soon |
...
| [Orgnise](https://open.aiflowlearn.net/orgnise) - A versatile project management platform that combines task organization, team collaboration, and workflow... | license: AGPL-3.0<br>⭐ Star: 241 | Notion, Obsidian, Linear | Coming soon | Coming soon |
| [CodeZero](https://open.aiflowlearn.net/codezero) - Open-source no-code automation platform for logistics, chatbots, and AI agents. | license: Unknown<br>⭐ Star: 35 | Zoho Flow, Azure Logic Apps | Coming soon | Coming soon |
| [MDMA](https://open.aiflowlearn.net/mdma) - Convert multi-step forms into conversational AI experiences. | license: MIT<br>⭐ Star: 18 | - | Coming soon | Coming soon |
...
| [Sol](https://open.aiflowlearn.net/sol) - A modern macOS launcher that provides instant access to applications, utilities, and system functions... | license: MIT<br>⭐ Star: 3K | Raycast, Alfred | Coming soon | Coming soon |
| [Kanri](https://open.aiflowlearn.net/kanri) - Kanri is a free, open-source personal Kanban app that works offline, offering a modern and simple... | license: GPL-3.0<br>⭐ Star: 1.9K | Monday, Jira, ClickUp | Coming soon | Coming soon |
| [Freeter](https://open.aiflowlearn.net/freeter) - Organize projects, tasks, and resources in customizable workspaces. | license: GPL-3.0<br>⭐ Star: 1K | Monday, ClickUp, Todoist | Coming soon | Coming soon |
| [TimeScribe](https://open.aiflowlearn.net/timescribe) - Advanced time tracking and productivity analytics tool that captures detailed work patterns, generates... | license: GPL-3.0<br>⭐ Star: 846 | Clockify, Toggl, TimeCamp | Coming soon | Coming soon |
| [Ever Teams](https://open.aiflowlearn.net/ever-teams) - Ever Teams offers an all-in-one solution for work management, time tracking, and team collaboration with... | license: AGPL-3.0<br>⭐ Star: 509 | Linear, Monday, Jira | Coming soon | Coming soon |
| [Ziit](https://open.aiflowlearn.net/ziit) - Monitor your coding sessions, analyze productivity patterns, and gain insights into your development... | license: AGPL-3.0<br>⭐ Star: 238 | RescueTime, WakaTime, Code Time | Coming soon | Coming soon |
| [Hackatime](https://open.aiflowlearn.net/hackatime) - Free, open-source coding time tracker compatible with VS Code, JetBrains IDEs, vim, emacs and more. | license: MIT<br>⭐ Star: 141 | WakaTime, Code Time | Coming soon | Coming soon |
...
| [Spliit](https://open.aiflowlearn.net/spliit) - A user-friendly app for tracking shared expenses, settling debts, and managing group finances with ease... | license: MIT<br>⭐ Star: 2.8K | - | Coming soon | Coming soon |
| [Splitpro](https://open.aiflowlearn.net/splitpro) - Free, open-source expense sharing app with multi-currency support, unequal splits, and receipt uploads. | license: MIT<br>⭐ Star: 1.3K | - | Coming soon | Coming soon |
| [Monetr](https://open.aiflowlearn.net/monetr) - Manage your money confidently with monetr, putting aside what you need and spending what you want | license: Unknown<br>⭐ Star: 666 | Splitwise, Quickbooks, YNAB | Coming soon | Coming soon |
| [YAFFA](https://open.aiflowlearn.net/yaffa) - YAFFA is a powerful, open-source budget app for managing expenses, budgets, and investments with secure... | license: MIT<br>⭐ Star: 104 | Quickbooks, YNAB, Mint | Coming soon | Coming soon |
...
| [Chalk.ist](https://open.aiflowlearn.net/chalkist) - Create beautiful, customizable images of your source code with ease, perfect for presentations,... | license: MIT<br>⭐ Star: 1.8K | - | Coming soon | Coming soon |

### Bookmark & Content Management

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Karakeep](https://open.aiflowlearn.net/karakeep) - Self-hostable bookmark manager that saves links, notes, images, and PDFs, then automatically tags and... | license: AGPL-3.0<br>⭐ Star: 26K | Pocket, Raindrop, Omnivore | Coming soon | Coming soon |
| [Linkwarden](https://open.aiflowlearn.net/linkwarden) - Open-source platform to collect, organize, and preserve webpages with powerful collaboration features | license: AGPL-3.0<br>⭐ Star: 19K | Pocket, Raindrop, Omnivore | Coming soon | Coming soon |
| [Wallabag](https://open.aiflowlearn.net/wallabag) - Self-hosted web article archiving tool that extracts content for comfortable reading. | license: MIT<br>⭐ Star: 13K | Pocket, Raindrop, Omnivore | Coming soon | Coming soon |
| [Linkding](https://open.aiflowlearn.net/linkding) - Minimal, fast bookmark manager with automatic metadata fetching, archiving, multi-user support, and... | license: MIT<br>⭐ Star: 11K | Pocket, Raindrop, Readwise Reader | Coming soon | Coming soon |
| [Ryot](https://open.aiflowlearn.net/ryot) - Ryot is a versatile platform for effortlessly tracking media, fitness, and more, replacing manual methods... | license: GPL-3.0<br>⭐ Star: 3.3K | Notion, Google Keep | Coming soon | Coming soon |
| [Faved](https://open.aiflowlearn.net/faved) - Free, open-source bookmark manager that's superfast and secure. | license: MIT<br>⭐ Star: 1.1K | Pocket, Raindrop, Omnivore | Coming soon | Coming soon |
| [Readeck](https://open.aiflowlearn.net/readeck) - Personal content hub for saving articles, videos, and images. | license: Unknown<br>⭐ Star: 993 | Pocket, Raindrop, Omnivore | Coming soon | Coming soon |
| [Bookmark It](https://open.aiflowlearn.net/bookmark-it) - Open-source bookmark manager with timeline view, one-click saving, categorization, and sharing features. | license: AGPL-3.0<br>⭐ Star: 323 | Pocket, Raindrop, Omnivore | Coming soon | Coming soon |
| [Brace.to](https://open.aiflowlearn.net/brace-to) - A privacy-focused bookmark manager that encrypts your saved links, allowing you to access them anytime,... | license: MIT<br>⭐ Star: 103 | Pocket, Raindrop, Omnivore | Coming soon | Coming soon |
| [Cloudmark](https://open.aiflowlearn.net/cloudmark) - Cloud-based bookmark manager that lets you save, categorize, and access your web favorites from any device... | license: AGPL-3.0<br>⭐ Star: 73 | Pocket, Raindrop, Evernote | Coming soon | Coming soon |

### Remote Desktop & Access

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [RustDesk](https://open.aiflowlearn.net/rustdesk) - Cross-platform remote desktop software that runs on your own servers, giving you full data control as a... | license: AGPL-3.0<br>⭐ Star: 116K | AnyDesk, TeamViewer, Splashtop | Coming soon | Coming soon |

### Browsers & Extensions

| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Ladybird](https://open.aiflowlearn.net/ladybird) - Open source web browser with its own engine, built from scratch without Blink, WebKit, or Gecko. | license: BSD-2-Clause<br>⭐ Star: 64K | Firefox, Comet Browser, Google Chrome | Coming soon | Coming soon |
| [Zen Browser](https://open.aiflowlearn.net/zen-browser) - A Firefox-based browser offering enhanced privacy, split views, and extensive customization options for a... | license: MPL-2.0<br>⭐ Star: 43K | Firefox, Comet Browser, Google Chrome | Coming soon | Coming soon |
| [Brave](https://open.aiflowlearn.net/brave) - A secure web browser that blocks ads and trackers, protects privacy, and loads pages faster while saving... | license: MPL-2.0<br>⭐ Star: 23K | Firefox, Google Chrome, Arc | Coming soon | Coming soon |
| [Screenity](https://open.aiflowlearn.net/screenity) - Capture, annotate, and edit screen recordings with no limits or sign-up required. | license: GPL-3.0<br>⭐ Star: 18K | Screen Studio, Loom, CleanShot | Coming soon | Coming soon |
...
| [Flow](https://open.aiflowlearn.net/flow) - A modern browser combining minimalist design with smart features like profiles, spaces, and command palette. | license: GPL-3.0<br>⭐ Star: 998 | Firefox, Comet Browser, Google Chrome | Coming soon | Coming soon |
| [Browser Operator](https://open.aiflowlearn.net/browser-operator) - Privacy-focused AI browser with intelligent agents for research, analysis, and workflow automation. | license: BSD-3-Clause<br>⭐ Star: 487 | Comet Browser, Browserbase, Atlas Browser | Coming soon | Coming soon |
| [Midori Browser](https://open.aiflowlearn.net/midori-browser) - Midori Browser is a lightweight, fast, and secure browser that protects users' privacy, available for... | license: MPL-2.0<br>⭐ Star: 335 | Firefox, Comet Browser, Google Chrome | Coming soon | Coming soon |
| [Cloudmark](https://open.aiflowlearn.net/cloudmark) - Cloud-based bookmark manager that lets you save, categorize, and access your web favorites from any device... | license: AGPL-3.0<br>⭐ Star: 73 | Pocket, Raindrop, Evernote | Coming soon | Coming soon |
...
| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [Handy](https://open.aiflowlearn.net/handy) - Cross-platform desktop app that transcribes your voice into any text field using a keyboard shortcut, with... | license: MIT<br>⭐ Star: 24K | Wispr Flow, Superwhisper, Aqua Voice | Coming soon | Coming soon |
| [VoiceInk](https://open.aiflowlearn.net/voiceink) - Convert speech to text instantly with advanced AI voice recognition. | license: Unknown<br>⭐ Star: 5.3K | Wispr Flow, Superwhisper, Aqua Voice | Coming soon | Coming soon |
| [OpenWispr](https://open.aiflowlearn.net/openwispr) - Dictation app powered by OpenAI Whisper and NVIDIA Parakeet. | license: MIT<br>⭐ Star: 3.7K | Wispr Flow, Superwhisper, Aqua Voice | Coming soon | Coming soon |
| [Amical](https://open.aiflowlearn.net/amical) - Open source AI dictation app that transforms speech to text with context-aware formatting. | license: MIT<br>⭐ Star: 1.4K | Wispr Flow, Superwhisper, Otter.ai | Coming soon | Coming soon |
| [Jarvis](https://open.aiflowlearn.net/jarvis) - Free, open-source macOS voice assistant that transcribes speech, applies AI transformations, and controls... | license: MIT<br>⭐ Star: 558 | Wispr Flow, Superwhisper, Voiceflow | Coming soon | Coming soon |
...
| Project | Github Info | Alternative To | Codex | Classroom |
| --- | --- | --- | --- | --- |
| [HashiCorp Vault](https://open.aiflowlearn.net/vault) - HashiCorp Vault is a powerful tool for managing secrets, protecting sensitive data, and controlling access... | license: Unknown<br>⭐ Star: 36K | 1Password, Doppler, Keeper | Coming soon | Coming soon |
| [Keycloak](https://open.aiflowlearn.net/keycloak) - Comprehensive open source identity management solution offering single sign-on, social login, and... | license: Apache-2.0<br>⭐ Star: 35K | WorkOS, Auth0, Okta | Coming soon | Coming soon |
| [JumpServer](https://open.aiflowlearn.net/jumpserver) - Open-source privileged access management solution offering secure, browser-based access to SSH, RDP,... | license: GPL-3.0<br>⭐ Star: 31K | Teleport, CyberArk | Coming soon | Coming soon |
| [Better Auth](https://open.aiflowlearn.net/better-auth) - A comprehensive authentication framework offering email/password, social sign-on, two-factor auth, and... | license: MIT<br>⭐ Star: 29K | Clerk, WorkOS, Auth0 | Coming soon | Coming soon |
| [Authentik](https://open.aiflowlearn.net/authentik) - authentik is an open-source identity provider that offers self-hosted authentication, authorization, and... | license: Unknown<br>⭐ Star: 22K | Clerk, WorkOS, Auth0 | Coming soon | Coming soon |
...
| [Defguard](https://open.aiflowlearn.net/defguard) - Enterprise-grade open source VPN solution combining WireGuard with mandatory 2FA/MFA and integrated OpenID... | license: Unknown<br>⭐ Star: 2.7K | NordVPN, Zerotier, Okta | Coming soon | Coming soon |
| [Authgear](https://open.aiflowlearn.net/authgear) - Authgear is a managed IAM platform handling authentication, SSO, and user management for B2C and B2B apps,... | license: Apache-2.0<br>⭐ Star: 1.8K | Clerk, WorkOS, Auth0 | Coming soon | Coming soon |
| [Tesseral](https://open.aiflowlearn.net/tesseral) - Complete B2B authentication solution with SSO, role management, API security, and pre-built UI components. | license: MIT<br>⭐ Star: 1.1K | Clerk, WorkOS, Auth0 | Coming soon | Coming soon |
| [Titan](https://open.aiflowlearn.net/titan) - Streamline role-based access control, enforce security policies, and ensure compliance for your Snowflake... | license: Apache-2.0<br>⭐ Star: 482 | Snowflake, BigQuery, RedShift | Coming soon | Coming soon |
...
| [UnKey](https://open.aiflowlearn.net/unkey) - Streamline API authentication with UnKey's powerful, developer-friendly platform for creating, revoking,... | license: AGPL-3.0<br>⭐ Star: 5.3K | Kong, Amazon API Gateway, Zuplo | Coming soon | Coming soon |
| [Phase](https://open.aiflowlearn.net/phase) - Open source platform for engineering teams to manage secrets and environment variables from development to... | license: Unknown<br>⭐ Star: 868 | 1Password, Doppler, Keeper | Coming soon | Coming soon |
| [Keyshade](https://open.aiflowlearn.net/keyshade) - Secure secret management platform with public key encryption, automated rotation, versioning, and... | license: MPL-2.0<br>⭐ Star: 754 | 1Password, Doppler, Keeper | Coming soon | Coming soon |
| [Werbot](https://open.aiflowlearn.net/werbot) - Centralized platform for managing SSH access, enhancing security, and streamlining server administration... | license: Unknown<br>⭐ Star: 169 | - | Coming soon | Coming soon |
...
| [Opengrep](https://open.aiflowlearn.net/opengrep) - Opengrep is a community-driven fork of SemgrepCE, providing accessible static code analysis and security... | license: LGPL-2.1<br>⭐ Star: 2.7K | - | Coming soon | Coming soon |
| [Flagr](https://open.aiflowlearn.net/flagr) - Flagr is a feature flagging, A/B testing and dynamic configuration microservice | license: Apache-2.0<br>⭐ Star: 2.6K | LaunchDarkly, Statsig | Coming soon | Coming soon |
| [mCaptcha](https://open.aiflowlearn.net/mcaptcha) - Privacy-focused proof-of-work CAPTCHA system that silently protects websites without tracking users or... | license: AGPL-3.0<br>⭐ Star: 2.5K | hCaptcha, reCAPTCHA, Cloudflare Turnstile | Coming soon | Coming soon |
| [ALTCHA](https://open.aiflowlearn.net/altcha) - ALTCHA offers cutting-edge spam and abuse protection for websites and apps, with privacy-friendly CAPTCHA... | license: MIT<br>⭐ Star: 2.4K | hCaptcha, reCAPTCHA, Cloudflare Turnstile | Coming soon | Coming soon |
| [FeatBit](https://open.aiflowlearn.net/featbit) - FeatBit is a fast, scalable feature flag service that enables risk mitigation and fosters business growth... | license: MIT<br>⭐ Star: 1.8K | LaunchDarkly, Hypertune, Statsig | Coming soon | Coming soon |
| [Featurevisor](https://open.aiflowlearn.net/featurevisor) - Featurevisor is an open-source tool for managing feature flags, experiments, and remote configuration... | license: MIT<br>⭐ Star: 801 | LaunchDarkly, Hypertune, Statsig | Coming soon | Coming soon |
| [Procaptcha](https://open.aiflowlearn.net/procaptcha) - A blockchain-based CAPTCHA solution offering improved security, user experience, and resistance to bot... | license: Apache-2.0<br>⭐ Star: 295 | hCaptcha, reCAPTCHA, Cloudflare Turnstile | Coming soon | Coming soon |
| [Private Captcha](https://open.aiflowlearn.net/private-captcha) - Privacy-first CAPTCHA service that blocks bots while keeping forms accessible. | license: Unknown<br>⭐ Star: 177 | hCaptcha, reCAPTCHA, Cloudflare Turnstile | Coming soon | Coming soon |
| [Abby](https://open.aiflowlearn.net/abby) - Abby offers open-source, fully typed feature flagging and remote configuration for React and Next.js, with... | license: AGPL-3.0<br>⭐ Star: 167 | LaunchDarkly, Hypertune, Statsig | Coming soon | Coming soon |
| [Friendly Captcha](https://open.aiflowlearn.net/friendly-captcha) - Privacy-compliant CAPTCHA alternative using proof-of-work technology. | license: MPL-2.0<br>⭐ Star: 27 | hCaptcha, reCAPTCHA, Cloudflare Turnstile | Coming soon | Coming soon |
...
| --- | --- | --- | --- | --- |
| [Tirreno](https://open.aiflowlearn.net/tirreno) - Open-source security framework for threat detection, fraud prevention, and abuse monitoring. | license: AGPL-3.0<br>⭐ Star: 1.4K | - | Coming soon | Coming soon |
| [Marble](https://open.aiflowlearn.net/marble) - An open-source platform that enables fintech companies to monitor transactions and user activity, detect... | license: Unknown<br>⭐ Star: 534 | Seon, SumSub, Feedzai | Coming soon | Coming soon |
...
| [Cal.com](https://open.aiflowlearn.net/cal-com) - Scheduling infrastructure for absolutely everyone. | license: MIT<br>⭐ Star: 46K | Calendly | Coming soon | Coming soon |
| [Mattermost](https://open.aiflowlearn.net/mattermost) - Mattermost is an open source platform for secure collaboration across the entire software development... | license: NOASSERTION<br>⭐ Star: 38K | Slack, Discord | Coming soon | Coming soon |
| [OpenAssistant](https://open.aiflowlearn.net/openassistant) - OpenAssistant is a chat-based assistant that understands tasks, can interact with third-party systems, and... | license: Apache-2.0<br>⭐ Star: 37K | ChatGPT, Claude | Coming soon | Coming soon |
...
| [Bitwarden](https://open.aiflowlearn.net/bitwarden-clients) - Bitwarden client apps (web, browser extension, desktop, and cli). | license: NOASSERTION<br>⭐ Star: 13K | 1Password, Lastpass | Coming soon | Coming soon |
| [ILLA](https://open.aiflowlearn.net/illa) - Low-code platform allows you to build business apps, enables you to quickly create internal tools such as... | license: Apache-2.0<br>⭐ Star: 12K | Retool, Appsmith | Coming soon | Coming soon |
| [doccano](https://open.aiflowlearn.net/doccano) - Open source annotation tool for machine learning practitioners. | license: MIT<br>⭐ Star: 11K | Label Studio | Coming soon | Coming soon |
| [Kanboard](https://open.aiflowlearn.net/kanboard) - Kanban project management software | license: MIT<br>⭐ Star: 9.6K | Trello, Jira | Coming soon | Coming soon |
| [ChatRWKV](https://open.aiflowlearn.net/chatrwkv) - ChatRWKV is like ChatGPT but powered by RWKV (100% RNN) language model, and open source. | license: Apache-2.0<br>⭐ Star: 9.5K | ChatGPT, Claude | Coming soon | Coming soon |
...
| [Kubero](https://open.aiflowlearn.net/kubero) - A free and self-hosted PaaS alternative to Heroku / Netlify / Coolify / Vercel / Dokku / Portainer running... | license: GPL-3.0<br>⭐ Star: 4.3K | Heroku, Vercel | Coming soon | Coming soon |
| [CozoDB](https://open.aiflowlearn.net/cozodb) - A transactional, relational-graph-vector database that uses Datalog for query. | license: MPL-2.0<br>⭐ Star: 4K | Pinecone, Weaviate | Coming soon | Coming soon |
| [crowd.dev](https://open.aiflowlearn.net/crowd-dev) - LFX Community Data Platform (CDP) | license: Apache-2.0<br>⭐ Star: 3.4K | Common Room, Orbit | Coming soon | Coming soon |
| [Peppermint](https://open.aiflowlearn.net/peppermint) - An open source issue management & help desk solution. | license: NOASSERTION<br>⭐ Star: 3.1K | Zendesk, FreshDesk | Coming soon | Coming soon |
| [Flagr](https://open.aiflowlearn.net/flagr) - Flagr is a feature flagging, A/B testing and dynamic configuration microservice | license: Apache-2.0<br>⭐ Star: 2.6K | LaunchDarkly, Statsig | Coming soon | Coming soon |
| [DashPress](https://open.aiflowlearn.net/dashpress) - Generate powerful admin apps without writing a single line of code - Run `npx dashpress` to see some magic! | license: AGPL-3.0<br>⭐ Star: 1.9K | Retool, Appsmith | Coming soon | Coming soon |
...
| [btw](https://open.aiflowlearn.net/btw) - Open source Medium alternative- set up your personal blog in minutes. | license: GPL-3.0<br>⭐ Star: 1.1K | Medium, WordPress | Coming soon | Coming soon |
| [Revert](https://open.aiflowlearn.net/revert) - Revert makes it incredibly easy to build integrations with any third party API | license: AGPL-3.0<br>⭐ Star: 1K | Merge, Tray IO | Coming soon | Coming soon |
| [Element Call](https://open.aiflowlearn.net/element-call) - Group calls powered by Matrix | license: AGPL-3.0<br>⭐ Star: 964 | Zoom, Google Meet | Coming soon | Coming soon |
| [SolidInvoice](https://open.aiflowlearn.net/solidinvoice) - Simple and elegant invoicing solution. | license: MIT<br>⭐ Star: 894 | Freshbooks, Quickbooks | Coming soon | Coming soon |
| [Bugzilla](https://open.aiflowlearn.net/bugzilla) - Official repository for the Bugzilla bug tracking system. | license: MPL-2.0<br>⭐ Star: 830 | Jira, Sentry | Coming soon | Coming soon |
| [DoTenX](https://open.aiflowlearn.net/dotenx) - No-code and Low-code all-in-one platform to build landing pages, websites, web applications, APIs,... | license: NOASSERTION<br>⭐ Star: 646 | Webflow, Wix | Coming soon | Coming soon |
